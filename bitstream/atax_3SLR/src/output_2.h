...
void task0_intra(float tmp[8], float A[400][416], float x[416], int i0);
void task1_intra(float tmp[8], float A[400][416], float x[416], int i0);
...
void write_tmp_FT0(float tmp[8], hls::stream<float8>& fifo_tmp_from_task1_to_task3, int i0);
