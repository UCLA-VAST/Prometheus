...
void store_vtmp_for_task1(hls::stream<float8>& fifo_tmp_to_off_chip, float8 vtmp[50]);
void FT0_level0(hls::stream<float8>& fifo_tmp_from_task1_to_task3, hls::stream<float16>& fifo_A_from_off_chip_to_S1, hls::stream<float16>& fifo_x_from_off_chip_to_S1, hls::stream<float8>& fifo_tmp_to_off_chip);
...
void write_tmp_FT0(float tmp[200], hls::stream<float8>& fifo_tmp_from_task1_to_task3, int i0);
void write_y_FT1(float y[16], hls::stream<float16>& fifo_y_to_off_chip, int j0);
void kernel_nlp(float8 vtmp_for_task1[50], float16 vA_for_task1[10400], float16 vA_for_task3[10400], float16 vx_for_task1[26], float16 vy_for_task3[26]);
