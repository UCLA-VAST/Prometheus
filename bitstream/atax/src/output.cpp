...
void compute_FT0_level0(hls::stream<float8> &fifo_tmp_from_task1_to_task3,
                        ...
                        float tmp_0[200], float tmp_1[200], float A[400][416],
                        float x[416]) {
#pragma HLS inline off
#pragma HLS dataflow
...
#pragma HLS array_partition variable = y_1 cyclic factor = 16 dim = 1
  float A_0[392][16];
  // FT1
#pragma HLS array_partition variable = A_0 cyclic factor = 28 dim = 1
#pragma HLS array_partition variable = A_0 cyclic factor = 16 dim = 2
  float A_1[392][16];
  // FT1
#pragma HLS array_partition variable = A_1 cyclic factor = 28 dim = 1
#pragma HLS array_partition variable = A_1 cyclic factor = 16 dim = 2
  float tmp[392];
#pragma HLS array_partition variable = tmp cyclic factor = 28 dim = 1
...
#pragma HLS inline off
  for (int d0_0 = 0; d0_0 < 2; d0_0++) {
    ...
    for (int d0_1 = 0; d0_1 < 200; d0_1 += 8) {
