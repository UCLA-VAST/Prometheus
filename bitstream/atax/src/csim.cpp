...
void kernel_nlp(float8 vtmp_for_task1[50], float16 vA_for_task1[10400],
...
int main() {
  ...
  float A_new_before_trans_0[400 * 416] = {0};
  float A_new_0[400 * 416] = {0};
  float A_new_before_trans_1[400 * 416] = {0};
  float A_new_1[400 * 416] = {0};
  float x_ori[410] = {0};
  ...
  float y_new_0[416] = {0};
  float tmp_ori[390] = {0};
  float tmp_new_before_trans_0[400] = {0};
  float tmp_new_0[400] = {0};
  int memIndex = 0;
  float val;
  ...
  for (int d1_0 = 0; d1_0 < 26; d1_0++) {
    for (int d0_0 = 0; d0_0 < 14; d0_0++) {
      for (int d0_1 = 0; d0_1 < 28; d0_1++) {
  ...
  memIndex = 0;
  //['d0_0', 'd0_1']
  for (int d0_0 = 0; d0_0 < 2; d0_0++) {
    for (int d0_1 = 0; d0_1 < 200; d0_1++) {
      int d0 = d0_0 * 200 + d0_1;
      tmp_new_0[memIndex] = tmp_new_before_trans_0[d0 * 1];
      memIndex++;
    }
  }
  kernel_atax(A_ori, x_ori, y_ori, tmp_ori);
  kernel_nlp((float8 *)tmp_new_0, (float16 *)A_new_0, (float16 *)A_new_1,
