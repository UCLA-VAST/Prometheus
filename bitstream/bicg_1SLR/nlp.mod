...
var cte_burst_TC5_for_p integer >= 1;
var cte_burst_TC2_for_A integer >= 1;
var cte_burst_TC5_for_A integer >= 1;
var cte_burst_TC0_for_s integer >= 1;
var cte_burst_TC2_for_s integer >= 1;
var cte_burst_TC3_for_q integer >= 1;
var cte_burst_TC4_for_q integer >= 1;
var cte_burst_TC1_for_r integer >= 1;
var Lat_comp_0_1 >= 0;
var obj >= 0;
...
subject to con103: TC0_1 = TC2_1; # same intra tile for the same dimension of the array s in the fused task
subject to con104: TC3_1 = TC4_1; # same intra tile for the same dimension of the array q in the fused task
subject to con105: p_is_fully_transfered_on_last_dim_FT1 = level_transfer_p_FT1_under0 + perm0_S3 * (level_transfer_p_FT1_under1); # the array p is fully transfered on the last dimension
subject to con106: burst_p_is_1 * cte_0 * 1 = burst_p_is_1 * ((1-is_tc5_burst_witout_tiling_for_p) * (TC5_1 * (1-p_is_fully_transfered_on_last_dim_FT1) + TC5 * (p_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_p * (cte_burst_without_tiling_TC5_for_p + TC5));
subject to con107: is_tc5_burst_witout_tiling_for_p =  min(1, cte_burst_without_tiling_TC5_for_p);
subject to con108: burst_p_is_2 * cte_1 * 2 = burst_p_is_2 * ((1-is_tc5_burst_witout_tiling_for_p) * (TC5_1 * (1-p_is_fully_transfered_on_last_dim_FT1) + TC5 * (p_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_p * (cte_burst_without_tiling_TC5_for_p + TC5));
subject to con109: burst_p_is_4 * cte_2 * 4 = burst_p_is_4 * ((1-is_tc5_burst_witout_tiling_for_p) * (TC5_1 * (1-p_is_fully_transfered_on_last_dim_FT1) + TC5 * (p_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_p * (cte_burst_without_tiling_TC5_for_p + TC5));
subject to con110: burst_p_is_8 * cte_3 * 8 = burst_p_is_8 * ((1-is_tc5_burst_witout_tiling_for_p) * (TC5_1 * (1-p_is_fully_transfered_on_last_dim_FT1) + TC5 * (p_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_p * (cte_burst_without_tiling_TC5_for_p + TC5));
subject to con111: burst_p_is_16 * cte_4 * 16 = burst_p_is_16 * ((1-is_tc5_burst_witout_tiling_for_p) * (TC5_1 * (1-p_is_fully_transfered_on_last_dim_FT1) + TC5 * (p_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_p * (cte_burst_without_tiling_TC5_for_p + TC5));
subject to con112: burst_p = burst_p_is_1 * 1 + burst_p_is_2 * 2 + burst_p_is_4 * 4 + burst_p_is_8 * 8 + burst_p_is_16 * 16; # burst size of the array p
subject to con113: burst_p_is_1 + burst_p_is_2 + burst_p_is_4 + burst_p_is_8 + burst_p_is_16 = 1; # only one burst size for the array p
subject to con114: is_tc5_burst_witout_tiling_for_p <= p_is_fully_transfered_on_last_dim_FT1;
subject to con115: A_is_fully_transfered_on_last_dim_FT0 = level_transfer_A_FT0_under0 + perm0_S1 * (level_transfer_A_FT0_under1); # the array A is fully transfered on the last dimension
subject to con116: A_is_fully_transfered_on_last_dim_FT1 = level_transfer_A_FT1_under0 + perm0_S3 * (level_transfer_A_FT1_under1); # the array A is fully transfered on the last dimension
subject to con117: burst_A_is_1 * cte_5 * 1 = burst_A_is_1 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con118: is_tc2_burst_witout_tiling_for_A =  min(1, cte_burst_without_tiling_TC2_for_A);
subject to con119: burst_A_is_1 * cte_6 * 1 = burst_A_is_1 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con120: is_tc5_burst_witout_tiling_for_A =  min(1, cte_burst_without_tiling_TC5_for_A);
subject to con121: burst_A_is_2 * cte_7 * 2 = burst_A_is_2 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con122: burst_A_is_2 * cte_8 * 2 = burst_A_is_2 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con123: burst_A_is_4 * cte_9 * 4 = burst_A_is_4 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con124: burst_A_is_4 * cte_10 * 4 = burst_A_is_4 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con125: burst_A_is_8 * cte_11 * 8 = burst_A_is_8 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con126: burst_A_is_8 * cte_12 * 8 = burst_A_is_8 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con127: burst_A_is_16 * cte_13 * 16 = burst_A_is_16 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con128: burst_A_is_16 * cte_14 * 16 = burst_A_is_16 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con129: burst_A = burst_A_is_1 * 1 + burst_A_is_2 * 2 + burst_A_is_4 * 4 + burst_A_is_8 * 8 + burst_A_is_16 * 16; # burst size of the array A
subject to con130: burst_A_is_1 + burst_A_is_2 + burst_A_is_4 + burst_A_is_8 + burst_A_is_16 = 1; # only one burst size for the array A
subject to con131: is_tc2_burst_witout_tiling_for_A <= A_is_fully_transfered_on_last_dim_FT0;
subject to con132: is_tc5_burst_witout_tiling_for_A <= A_is_fully_transfered_on_last_dim_FT1;
subject to con133: s_is_fully_transfered_on_last_dim_FT0 = level_transfer_s_FT0_under0; # the array s is fully transfered on the last dimension
subject to con134: s_is_fully_transfered_on_last_dim_FT0 = level_transfer_s_FT0_under0 + perm0_S1 * (level_transfer_s_FT0_under1); # the array s is fully transfered on the last dimension
subject to con135: burst_s_is_1 * cte_15 * 1 = burst_s_is_1 * ((1-is_tc0_burst_witout_tiling_for_s) * (TC0_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC0 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC0_for_s + TC0));
subject to con136: is_tc0_burst_witout_tiling_for_s =  min(1, cte_burst_without_tiling_TC0_for_s);
subject to con137: burst_s_is_1 * cte_16 * 1 = burst_s_is_1 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con138: is_tc2_burst_witout_tiling_for_s =  min(1, cte_burst_without_tiling_TC2_for_s);
subject to con139: burst_s_is_1 * cte_17 * 1 = burst_s_is_1 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con140: burst_s_is_2 * cte_18 * 2 = burst_s_is_2 * ((1-is_tc0_burst_witout_tiling_for_s) * (TC0_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC0 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC0_for_s + TC0));
subject to con141: burst_s_is_2 * cte_19 * 2 = burst_s_is_2 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con142: burst_s_is_2 * cte_20 * 2 = burst_s_is_2 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con143: burst_s_is_4 * cte_21 * 4 = burst_s_is_4 * ((1-is_tc0_burst_witout_tiling_for_s) * (TC0_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC0 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC0_for_s + TC0));
subject to con144: burst_s_is_4 * cte_22 * 4 = burst_s_is_4 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con145: burst_s_is_4 * cte_23 * 4 = burst_s_is_4 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con146: burst_s_is_8 * cte_24 * 8 = burst_s_is_8 * ((1-is_tc0_burst_witout_tiling_for_s) * (TC0_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC0 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC0_for_s + TC0));
subject to con147: burst_s_is_8 * cte_25 * 8 = burst_s_is_8 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con148: burst_s_is_8 * cte_26 * 8 = burst_s_is_8 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con149: burst_s_is_16 * cte_27 * 16 = burst_s_is_16 * ((1-is_tc0_burst_witout_tiling_for_s) * (TC0_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC0 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC0_for_s + TC0));
subject to con150: burst_s_is_16 * cte_28 * 16 = burst_s_is_16 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con151: burst_s_is_16 * cte_29 * 16 = burst_s_is_16 * ((1-is_tc2_burst_witout_tiling_for_s) * (TC2_1 * (1-s_is_fully_transfered_on_last_dim_FT0) + TC2 * (s_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_s * (cte_burst_without_tiling_TC2_for_s + TC2));
subject to con152: burst_s = burst_s_is_1 * 1 + burst_s_is_2 * 2 + burst_s_is_4 * 4 + burst_s_is_8 * 8 + burst_s_is_16 * 16; # burst size of the array s
subject to con153: burst_s_is_1 + burst_s_is_2 + burst_s_is_4 + burst_s_is_8 + burst_s_is_16 = 1; # only one burst size for the array s
subject to con154: is_tc0_burst_witout_tiling_for_s <= s_is_fully_transfered_on_last_dim_FT0;
subject to con155: is_tc2_burst_witout_tiling_for_s <= s_is_fully_transfered_on_last_dim_FT0;
subject to con156: q_is_fully_transfered_on_last_dim_FT1 = level_transfer_q_FT1_under0; # the array q is fully transfered on the last dimension
subject to con157: q_is_fully_transfered_on_last_dim_FT1 = level_transfer_q_FT1_under0 + perm1_S3 * (level_transfer_q_FT1_under1); # the array q is fully transfered on the last dimension
subject to con158: burst_q_is_1 * cte_30 * 1 = burst_q_is_1 * ((1-is_tc3_burst_witout_tiling_for_q) * (TC3_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC3 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC3_for_q + TC3));
subject to con159: is_tc3_burst_witout_tiling_for_q =  min(1, cte_burst_without_tiling_TC3_for_q);
subject to con160: burst_q_is_1 * cte_31 * 1 = burst_q_is_1 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con161: is_tc4_burst_witout_tiling_for_q =  min(1, cte_burst_without_tiling_TC4_for_q);
subject to con162: burst_q_is_1 * cte_32 * 1 = burst_q_is_1 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con163: burst_q_is_2 * cte_33 * 2 = burst_q_is_2 * ((1-is_tc3_burst_witout_tiling_for_q) * (TC3_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC3 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC3_for_q + TC3));
subject to con164: burst_q_is_2 * cte_34 * 2 = burst_q_is_2 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con165: burst_q_is_2 * cte_35 * 2 = burst_q_is_2 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con166: burst_q_is_4 * cte_36 * 4 = burst_q_is_4 * ((1-is_tc3_burst_witout_tiling_for_q) * (TC3_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC3 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC3_for_q + TC3));
subject to con167: burst_q_is_4 * cte_37 * 4 = burst_q_is_4 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con168: burst_q_is_4 * cte_38 * 4 = burst_q_is_4 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con169: burst_q_is_8 * cte_39 * 8 = burst_q_is_8 * ((1-is_tc3_burst_witout_tiling_for_q) * (TC3_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC3 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC3_for_q + TC3));
subject to con170: burst_q_is_8 * cte_40 * 8 = burst_q_is_8 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con171: burst_q_is_8 * cte_41 * 8 = burst_q_is_8 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con172: burst_q_is_16 * cte_42 * 16 = burst_q_is_16 * ((1-is_tc3_burst_witout_tiling_for_q) * (TC3_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC3 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC3_for_q + TC3));
subject to con173: burst_q_is_16 * cte_43 * 16 = burst_q_is_16 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con174: burst_q_is_16 * cte_44 * 16 = burst_q_is_16 * ((1-is_tc4_burst_witout_tiling_for_q) * (TC4_1 * (1-q_is_fully_transfered_on_last_dim_FT1) + TC4 * (q_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_q * (cte_burst_without_tiling_TC4_for_q + TC4));
subject to con175: burst_q = burst_q_is_1 * 1 + burst_q_is_2 * 2 + burst_q_is_4 * 4 + burst_q_is_8 * 8 + burst_q_is_16 * 16; # burst size of the array q
subject to con176: burst_q_is_1 + burst_q_is_2 + burst_q_is_4 + burst_q_is_8 + burst_q_is_16 = 1; # only one burst size for the array q
subject to con177: is_tc3_burst_witout_tiling_for_q <= q_is_fully_transfered_on_last_dim_FT1;
subject to con178: is_tc4_burst_witout_tiling_for_q <= q_is_fully_transfered_on_last_dim_FT1;
subject to con179: r_is_fully_transfered_on_last_dim_FT0 = level_transfer_r_FT0_under0 + perm1_S1 * (level_transfer_r_FT0_under1); # the array r is fully transfered on the last dimension
subject to con180: burst_r_is_1 * cte_45 * 1 = burst_r_is_1 * ((1-is_tc1_burst_witout_tiling_for_r) * (TC1_1 * (1-r_is_fully_transfered_on_last_dim_FT0) + TC1 * (r_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_r * (cte_burst_without_tiling_TC1_for_r + TC1));
subject to con181: is_tc1_burst_witout_tiling_for_r =  min(1, cte_burst_without_tiling_TC1_for_r);
subject to con182: burst_r_is_2 * cte_46 * 2 = burst_r_is_2 * ((1-is_tc1_burst_witout_tiling_for_r) * (TC1_1 * (1-r_is_fully_transfered_on_last_dim_FT0) + TC1 * (r_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_r * (cte_burst_without_tiling_TC1_for_r + TC1));
subject to con183: burst_r_is_4 * cte_47 * 4 = burst_r_is_4 * ((1-is_tc1_burst_witout_tiling_for_r) * (TC1_1 * (1-r_is_fully_transfered_on_last_dim_FT0) + TC1 * (r_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_r * (cte_burst_without_tiling_TC1_for_r + TC1));
subject to con184: burst_r_is_8 * cte_48 * 8 = burst_r_is_8 * ((1-is_tc1_burst_witout_tiling_for_r) * (TC1_1 * (1-r_is_fully_transfered_on_last_dim_FT0) + TC1 * (r_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_r * (cte_burst_without_tiling_TC1_for_r + TC1));
subject to con185: burst_r_is_16 * cte_49 * 16 = burst_r_is_16 * ((1-is_tc1_burst_witout_tiling_for_r) * (TC1_1 * (1-r_is_fully_transfered_on_last_dim_FT0) + TC1 * (r_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_r * (cte_burst_without_tiling_TC1_for_r + TC1));
subject to con186: burst_r = burst_r_is_1 * 1 + burst_r_is_2 * 2 + burst_r_is_4 * 4 + burst_r_is_8 * 8 + burst_r_is_16 * 16; # burst size of the array r
subject to con187: burst_r_is_1 + burst_r_is_2 + burst_r_is_4 + burst_r_is_8 + burst_r_is_16 = 1; # only one burst size for the array r
subject to con188: is_tc1_burst_witout_tiling_for_r <= r_is_fully_transfered_on_last_dim_FT0;
subject to con189: TC5_1 = burst_p * cte_burst_TC5_for_p;
subject to con190: footprint_tot_p_FT1 = TC5_0 * (TC5_1 + cte_burst_without_tiling_TC5_for_p);
subject to con191: TC2_1 = burst_A * cte_burst_TC2_for_A;
subject to con192: footprint_tot_A_FT0 = TC1_ori * TC2_0 * (TC2_1 + cte_burst_without_tiling_TC2_for_A);
subject to con193: TC5_1 = burst_A * cte_burst_TC5_for_A;
subject to con194: footprint_tot_A_FT1 = TC4_ori * TC5_0 * (TC5_1 + cte_burst_without_tiling_TC5_for_A);
subject to con195: TC0_1 = burst_s * cte_burst_TC0_for_s;
subject to con196: footprint_tot_s_FT0 = TC0_0 * (TC0_1 + cte_burst_without_tiling_TC0_for_s);
subject to con197: TC2_1 = burst_s * cte_burst_TC2_for_s;
subject to con198: footprint_tot_s_FT0 = TC2_0 * (TC2_1 + cte_burst_without_tiling_TC2_for_s);
subject to con199: TC3_1 = burst_q * cte_burst_TC3_for_q;
subject to con200: footprint_tot_q_FT1 = TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_q);
subject to con201: TC4_1 = burst_q * cte_burst_TC4_for_q;
subject to con202: footprint_tot_q_FT1 = TC4_0 * (TC4_1 + cte_burst_without_tiling_TC4_for_q);
subject to con203: TC1_1 = burst_r * cte_burst_TC1_for_r;
subject to con204: footprint_tot_r_FT0 = TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_r);
subject to con205: obj = max(shift_0_to_1 + Lat_comp_fused_S2_S3, Lat_comp_fused_S0_S1) + 1/burst_p + 1/burst_A + 1/burst_s + 1/burst_q + 1/burst_r + 1/(is_slr0_used);
...
subject to con213: perm0_S3 * level_reuse_p_FT1_under0 = perm0_S3 * 1;
subject to con214: perm0_S1 * level_reuse_s_FT0_under0 = perm0_S1 * 1;
subject to con215: perm1_S3 * level_reuse_q_FT1_under0 = perm1_S3 * 1;
subject to con216: perm1_S1 * level_reuse_r_FT0_under0 = perm1_S1 * 1;
solve;
display TC0;
display TC1;
display TC2;
...
display burst_r;
display cte_burst_TC5_for_p;
display cte_burst_TC2_for_A;
display cte_burst_TC5_for_A;
display cte_burst_TC0_for_s;
display cte_burst_TC2_for_s;
display cte_burst_TC3_for_q;
display cte_burst_TC4_for_q;
display cte_burst_TC1_for_r;
