...
subject to con87: A1_is_fully_transfered_on_last_dim_FT0 = level_transfer_A1_FT0_under0 + perm0_S1 * (level_transfer_A1_FT0_under1) + perm1_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm4_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm5_S1 * (level_transfer_A1_FT0_under1); # the array A1 is fully transfered on the last dimension
subject to con88: burst_A1_is_1 * cte_0 * 1 = burst_A1_is_1 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con89: is_tc3_burst_witout_tiling_for_A1 =  min(1, cte_burst_without_tiling_TC3_for_A1);
subject to con90: burst_A1_is_2 * cte_1 * 2 = burst_A1_is_2 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con91: burst_A1_is_4 * cte_2 * 4 = burst_A1_is_4 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con92: burst_A1_is_8 * cte_3 * 8 = burst_A1_is_8 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con93: burst_A1_is_16 * cte_4 * 16 = burst_A1_is_16 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
...
subject to con96: is_tc3_burst_witout_tiling_for_A1 <= A1_is_fully_transfered_on_last_dim_FT0;
...
subject to con125: A2_is_fully_transfered_on_last_dim_FT0 = level_transfer_A2_FT0_under0 + perm0_S1 * (level_transfer_A2_FT0_under1) + perm1_S1 * (level_transfer_A2_FT0_under1 + level_transfer_A2_FT0_under2) + perm4_S1 * (level_transfer_A2_FT0_under1 + level_transfer_A2_FT0_under2) + perm5_S1 * (level_transfer_A2_FT0_under1); # the array A2 is fully transfered on the last dimension
subject to con126: burst_A2_is_1 * cte_25 * 1 = burst_A2_is_1 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con127: is_tc3_burst_witout_tiling_for_A2 =  min(1, cte_burst_without_tiling_TC3_for_A2);
subject to con128: burst_A2_is_2 * cte_26 * 2 = burst_A2_is_2 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con129: burst_A2_is_4 * cte_27 * 4 = burst_A2_is_4 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con130: burst_A2_is_8 * cte_28 * 8 = burst_A2_is_8 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con131: burst_A2_is_16 * cte_29 * 16 = burst_A2_is_16 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con132: burst_A2 = burst_A2_is_1 * 1 + burst_A2_is_2 * 2 + burst_A2_is_4 * 4 + burst_A2_is_8 * 8 + burst_A2_is_16 * 16; # burst size of the array A2
subject to con133: burst_A2_is_1 + burst_A2_is_2 + burst_A2_is_4 + burst_A2_is_8 + burst_A2_is_16 = 1; # only one burst size for the array A2
subject to con134: is_tc3_burst_witout_tiling_for_A2 <= A2_is_fully_transfered_on_last_dim_FT0;
subject to con135: footprint_tot_A1_FT0 = TC2_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_A1);
...
subject to con138: footprint_tot_A2_FT0 = TC4_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_A2);
subject to con139: TC0 = TC0_ori;
subject to con140: TC2 = TC2_ori;
subject to con141: obj = Lat_comp_fused_S0_S1 + 1/burst_A1 + 1/burst_C + 1/burst_A2 + 1/(is_slr0_used);
...
subject to con147: perm4_S1 * level_reuse_A1_FT0_under0 = perm4_S1 * 1;
subject to con148: perm5_S1 * level_reuse_A1_FT0_under0 = perm5_S1 * 1;
...
subject to con151: perm0_S1 * level_reuse_A2_FT0_under0 = perm0_S1 * 1;
subject to con152: perm1_S1 * level_reuse_A2_FT0_under0 = perm1_S1 * 1;
solve;
display TC0;
display TC1;
display TC2;
