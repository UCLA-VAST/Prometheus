...
subject to con95: C_is_fully_transfered_on_last_dim_FT0 = level_transfer_C_FT0_under0 + perm0_S0 * (level_transfer_C_FT0_under1) + perm1_S0 * (level_transfer_C_FT0_under1 + level_transfer_C_FT0_under2) + perm4_S0 * (level_transfer_C_FT0_under1 + level_transfer_C_FT0_under2) + perm5_S0 * (level_transfer_C_FT0_under1); # the array C is fully transfered on the last dimension
subject to con96: burst_C_is_1 * cte_0 * 1 = burst_C_is_1 * ((1-is_tc1_burst_witout_tiling_for_C) * (TC1_1 * (1-C_is_fully_transfered_on_last_dim_FT0) + TC1 * (C_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC1_for_C + TC1));
subject to con97: is_tc1_burst_witout_tiling_for_C =  min(1, cte_burst_without_tiling_TC1_for_C);
subject to con98: burst_C_is_2 * cte_1 * 2 = burst_C_is_2 * ((1-is_tc1_burst_witout_tiling_for_C) * (TC1_1 * (1-C_is_fully_transfered_on_last_dim_FT0) + TC1 * (C_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC1_for_C + TC1));
subject to con99: burst_C_is_4 * cte_2 * 4 = burst_C_is_4 * ((1-is_tc1_burst_witout_tiling_for_C) * (TC1_1 * (1-C_is_fully_transfered_on_last_dim_FT0) + TC1 * (C_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC1_for_C + TC1));
subject to con100: burst_C_is_8 * cte_3 * 8 = burst_C_is_8 * ((1-is_tc1_burst_witout_tiling_for_C) * (TC1_1 * (1-C_is_fully_transfered_on_last_dim_FT0) + TC1 * (C_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC1_for_C + TC1));
subject to con101: burst_C_is_16 * cte_4 * 16 = burst_C_is_16 * ((1-is_tc1_burst_witout_tiling_for_C) * (TC1_1 * (1-C_is_fully_transfered_on_last_dim_FT0) + TC1 * (C_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC1_for_C + TC1));
subject to con102: burst_C = burst_C_is_1 * 1 + burst_C_is_2 * 2 + burst_C_is_4 * 4 + burst_C_is_8 * 8 + burst_C_is_16 * 16; # burst size of the array C
subject to con103: burst_C_is_1 + burst_C_is_2 + burst_C_is_4 + burst_C_is_8 + burst_C_is_16 = 1; # only one burst size for the array C
subject to con104: is_tc1_burst_witout_tiling_for_C <= C_is_fully_transfered_on_last_dim_FT0;
subject to con105: B_is_fully_transfered_on_last_dim_FT0 = level_transfer_B_FT0_under0 + perm0_S0 * (level_transfer_B_FT0_under1) + perm1_S0 * (level_transfer_B_FT0_under1 + level_transfer_B_FT0_under2) + perm4_S0 * (level_transfer_B_FT0_under1 + level_transfer_B_FT0_under2) + perm5_S0 * (level_transfer_B_FT0_under1); # the array B is fully transfered on the last dimension
subject to con106: B_is_fully_transfered_on_last_dim_FT0 = level_transfer_B_FT0_under0 + perm0_S1 * (level_transfer_B_FT0_under1); # the array B is fully transfered on the last dimension
subject to con107: burst_B_is_1 * cte_5 * 1 = burst_B_is_1 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con108: is_tc1_burst_witout_tiling_for_B =  min(1, cte_burst_without_tiling_TC1_for_B);
subject to con109: burst_B_is_1 * cte_6 * 1 = burst_B_is_1 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con110: burst_B_is_1 * cte_7 * 1 = burst_B_is_1 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con111: is_tc4_burst_witout_tiling_for_B =  min(1, cte_burst_without_tiling_TC4_for_B);
subject to con112: burst_B_is_1 * cte_8 * 1 = burst_B_is_1 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con113: burst_B_is_2 * cte_9 * 2 = burst_B_is_2 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con114: burst_B_is_2 * cte_10 * 2 = burst_B_is_2 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con115: burst_B_is_2 * cte_11 * 2 = burst_B_is_2 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con116: burst_B_is_2 * cte_12 * 2 = burst_B_is_2 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con117: burst_B_is_4 * cte_13 * 4 = burst_B_is_4 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con118: burst_B_is_4 * cte_14 * 4 = burst_B_is_4 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con119: burst_B_is_4 * cte_15 * 4 = burst_B_is_4 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con120: burst_B_is_4 * cte_16 * 4 = burst_B_is_4 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con121: burst_B_is_8 * cte_17 * 8 = burst_B_is_8 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con122: burst_B_is_8 * cte_18 * 8 = burst_B_is_8 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con123: burst_B_is_8 * cte_19 * 8 = burst_B_is_8 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con124: burst_B_is_8 * cte_20 * 8 = burst_B_is_8 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con125: burst_B_is_16 * cte_21 * 16 = burst_B_is_16 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con126: burst_B_is_16 * cte_22 * 16 = burst_B_is_16 * ((1-is_tc1_burst_witout_tiling_for_B) * (TC1_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC1 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC1_for_B + TC1));
subject to con127: burst_B_is_16 * cte_23 * 16 = burst_B_is_16 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con128: burst_B_is_16 * cte_24 * 16 = burst_B_is_16 * ((1-is_tc4_burst_witout_tiling_for_B) * (TC4_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC4 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC4_for_B + TC4));
subject to con129: burst_B = burst_B_is_1 * 1 + burst_B_is_2 * 2 + burst_B_is_4 * 4 + burst_B_is_8 * 8 + burst_B_is_16 * 16; # burst size of the array B
subject to con130: burst_B_is_1 + burst_B_is_2 + burst_B_is_4 + burst_B_is_8 + burst_B_is_16 = 1; # only one burst size for the array B
subject to con131: is_tc1_burst_witout_tiling_for_B <= B_is_fully_transfered_on_last_dim_FT0;
subject to con132: is_tc4_burst_witout_tiling_for_B <= B_is_fully_transfered_on_last_dim_FT0;
...
subject to con143: footprint_tot_C_FT0 = TC2_ori * TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_C);
subject to con144: footprint_tot_B_FT0 = TC0_ori * TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_B);
subject to con145: footprint_tot_B_FT0 = TC3_ori * TC4_0 * (TC4_1 + cte_burst_without_tiling_TC4_for_B);
...
subject to con149: obj = Lat_comp_fused_S0_S1 + 1/burst_C + 1/burst_B + 1/burst_A + 1/(is_slr0_used);
...
subject to con155: perm0_S0 * level_reuse_C_FT0_under0 = perm0_S0 * 1;
subject to con156: perm1_S0 * level_reuse_C_FT0_under0 = perm1_S0 * 1;
subject to con157: perm4_S0 * level_reuse_B_FT0_under0 = perm4_S0 * 1;
subject to con158: perm5_S0 * level_reuse_B_FT0_under0 = perm5_S0 * 1;
