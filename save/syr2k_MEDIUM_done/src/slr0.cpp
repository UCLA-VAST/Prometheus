...
#pragma HLS pipeline II = 1
    ...
    fifo_B2_from_off_chip_to_S1.write(vB2_on);
  }
}
...
#pragma HLS pipeline II = 1
    float4 vC_off;
    ap_axiu<128, 0, 0, 0> vC_on = fifo_C_to_off_chip.read();
    uint32_t vC_tmp[4];
...
#pragma HLS inline off
  float B1_0[30][208];
  // FT0
#pragma HLS array_partition variable = B1_0 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = B1_0 cyclic factor = 4 dim = 2
  float B1_1[30][208];
  // FT0
#pragma HLS array_partition variable = B1_1 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = B1_1 cyclic factor = 4 dim = 2
  float A2_0[30][208];
  // FT0
#pragma HLS array_partition variable = A2_0 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = A2_0 cyclic factor = 4 dim = 2
  float A2_1[30][208];
  // FT0
#pragma HLS array_partition variable = A2_1 cyclic factor = 30 dim = 1
...
#pragma HLS array_partition variable = B2_2 cyclic factor = 4 dim = 2
  ...
  for (int i0 = 0; i0 < 8; i0++) {
    if (i0 % 2 == 0) {
      ...
      FT0_level1(alpha, beta, fifo_C_from_off_chip_to_S0,
                 fifo_B1_from_off_chip_to_S1, fifo_B2_from_off_chip_to_S1,
                 fifo_A2_from_off_chip_to_S1, fifo_A1_from_off_chip_to_S1,
...
#pragma HLS inline off
  float C_0[30][12];
  // FT0
#pragma HLS array_partition variable = C_0 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = C_0 cyclic factor = 12 dim = 2
  float C_1[30][12];
  // FT0
#pragma HLS array_partition variable = C_1 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = C_1 cyclic factor = 12 dim = 2
  float C_2[30][12];
  // FT0
#pragma HLS array_partition variable = C_2 cyclic factor = 30 dim = 1
#pragma HLS array_partition variable = C_2 cyclic factor = 12 dim = 2
  ...
  for (int j0 = 0; j0 < 20; j0++) {
    ...
    if (j0 % 3 == 0) {
      ...
      //     write_C_FT0(C_2, fifo_C_to_off_chip, j0-1, i0);
      compute_FT0_level1(
          alpha, beta, fifo_C_from_off_chip_to_S0, fifo_B1_from_off_chip_to_S1,
          fifo_B2_from_off_chip_to_S1, fifo_A2_from_off_chip_to_S1,
          fifo_A1_from_off_chip_to_S1, fifo_C_to_off_chip, B1, A2, i0, j0, C_1,
      ...
      compute_FT0_level1(
          alpha, beta, fifo_C_from_off_chip_to_S0, fifo_B1_from_off_chip_to_S1,
          fifo_B2_from_off_chip_to_S1, fifo_A2_from_off_chip_to_S1,
          fifo_A1_from_off_chip_to_S1, fifo_C_to_off_chip, B1, A2, i0, j0, C_2,
      ...
      compute_FT0_level1(
          alpha, beta, fifo_C_from_off_chip_to_S0, fifo_B1_from_off_chip_to_S1,
          fifo_B2_from_off_chip_to_S1, fifo_A2_from_off_chip_to_S1,
          fifo_A1_from_off_chip_to_S1, fifo_C_to_off_chip, B1, A2, i0, j0, C_0,
...
#pragma HLS inline off
  ...
  for (int d0 = 0; d0 < 30; d0++) {
    for (int d1 = 0; d1 < 12; d1 += 4) {
#pragma HLS pipeline II = 1
      ap_axiu<128, 0, 0, 0> tmp_fifo = fifo_C_from_off_chip_to_S0.read();
      uint32_t tmp_0 = tmp_fifo.data.range(31, 0);
...
#pragma HLS pipeline II = 1
      ...
      uint32_t tmp_0 = tmp_fifo.data.range(31, 0);
      A1[d0 + j0 * 12][d1 + 0 + 0] = *(float *)(&tmp_0);
      uint32_t tmp_1 = tmp_fifo.data.range(63, 32);
      A1[d0 + j0 * 12][d1 + 0 + 1] = *(float *)(&tmp_1);
      uint32_t tmp_2 = tmp_fifo.data.range(95, 64);
      A1[d0 + j0 * 12][d1 + 0 + 2] = *(float *)(&tmp_2);
      uint32_t tmp_3 = tmp_fifo.data.range(127, 96);
      A1[d0 + j0 * 12][d1 + 0 + 3] = *(float *)(&tmp_3);
      uint32_t tmp_4 = tmp_fifo.data.range(159, 128);
      A1[d0 + j0 * 12][d1 + 0 + 4] = *(float *)(&tmp_4);
      uint32_t tmp_5 = tmp_fifo.data.range(191, 160);
      A1[d0 + j0 * 12][d1 + 0 + 5] = *(float *)(&tmp_5);
      uint32_t tmp_6 = tmp_fifo.data.range(223, 192);
      A1[d0 + j0 * 12][d1 + 0 + 6] = *(float *)(&tmp_6);
      uint32_t tmp_7 = tmp_fifo.data.range(255, 224);
      A1[d0 + j0 * 12][d1 + 0 + 7] = *(float *)(&tmp_7);
      uint32_t tmp_8 = tmp_fifo.data.range(287, 256);
      A1[d0 + j0 * 12][d1 + 0 + 8] = *(float *)(&tmp_8);
      uint32_t tmp_9 = tmp_fifo.data.range(319, 288);
      A1[d0 + j0 * 12][d1 + 0 + 9] = *(float *)(&tmp_9);
      uint32_t tmp_10 = tmp_fifo.data.range(351, 320);
      A1[d0 + j0 * 12][d1 + 0 + 10] = *(float *)(&tmp_10);
      uint32_t tmp_11 = tmp_fifo.data.range(383, 352);
      A1[d0 + j0 * 12][d1 + 0 + 11] = *(float *)(&tmp_11);
      uint32_t tmp_12 = tmp_fifo.data.range(415, 384);
      A1[d0 + j0 * 12][d1 + 0 + 12] = *(float *)(&tmp_12);
      uint32_t tmp_13 = tmp_fifo.data.range(447, 416);
      A1[d0 + j0 * 12][d1 + 0 + 13] = *(float *)(&tmp_13);
      uint32_t tmp_14 = tmp_fifo.data.range(479, 448);
      A1[d0 + j0 * 12][d1 + 0 + 14] = *(float *)(&tmp_14);
      uint32_t tmp_15 = tmp_fifo.data.range(511, 480);
      A1[d0 + j0 * 12][d1 + 0 + 15] = *(float *)(&tmp_15);
    }
  }
}
...
#pragma HLS inline off
  ...
  for (int d0 = 0; d0 < 12; d0++) {
    for (int d1 = 0; d1 < 208; d1 += 16) {
#pragma HLS pipeline II = 1
      ap_axiu<512, 0, 0, 0> tmp_fifo = fifo_B2_from_off_chip_to_S1.read();
      uint32_t tmp_0 = tmp_fifo.data.range(31, 0);
      B2[d0 + j0 * 12][d1 + 0 + 0] = *(float *)(&tmp_0);
      uint32_t tmp_1 = tmp_fifo.data.range(63, 32);
      B2[d0 + j0 * 12][d1 + 0 + 1] = *(float *)(&tmp_1);
      uint32_t tmp_2 = tmp_fifo.data.range(95, 64);
      B2[d0 + j0 * 12][d1 + 0 + 2] = *(float *)(&tmp_2);
      uint32_t tmp_3 = tmp_fifo.data.range(127, 96);
      B2[d0 + j0 * 12][d1 + 0 + 3] = *(float *)(&tmp_3);
      uint32_t tmp_4 = tmp_fifo.data.range(159, 128);
      B2[d0 + j0 * 12][d1 + 0 + 4] = *(float *)(&tmp_4);
      uint32_t tmp_5 = tmp_fifo.data.range(191, 160);
      B2[d0 + j0 * 12][d1 + 0 + 5] = *(float *)(&tmp_5);
      uint32_t tmp_6 = tmp_fifo.data.range(223, 192);
      B2[d0 + j0 * 12][d1 + 0 + 6] = *(float *)(&tmp_6);
      uint32_t tmp_7 = tmp_fifo.data.range(255, 224);
      B2[d0 + j0 * 12][d1 + 0 + 7] = *(float *)(&tmp_7);
      uint32_t tmp_8 = tmp_fifo.data.range(287, 256);
      B2[d0 + j0 * 12][d1 + 0 + 8] = *(float *)(&tmp_8);
      uint32_t tmp_9 = tmp_fifo.data.range(319, 288);
      B2[d0 + j0 * 12][d1 + 0 + 9] = *(float *)(&tmp_9);
      uint32_t tmp_10 = tmp_fifo.data.range(351, 320);
      B2[d0 + j0 * 12][d1 + 0 + 10] = *(float *)(&tmp_10);
      uint32_t tmp_11 = tmp_fifo.data.range(383, 352);
      B2[d0 + j0 * 12][d1 + 0 + 11] = *(float *)(&tmp_11);
      uint32_t tmp_12 = tmp_fifo.data.range(415, 384);
      B2[d0 + j0 * 12][d1 + 0 + 12] = *(float *)(&tmp_12);
      uint32_t tmp_13 = tmp_fifo.data.range(447, 416);
      B2[d0 + j0 * 12][d1 + 0 + 13] = *(float *)(&tmp_13);
      uint32_t tmp_14 = tmp_fifo.data.range(479, 448);
      B2[d0 + j0 * 12][d1 + 0 + 14] = *(float *)(&tmp_14);
      uint32_t tmp_15 = tmp_fifo.data.range(511, 480);
      B2[d0 + j0 * 12][d1 + 0 + 15] = *(float *)(&tmp_15);
    }
  }
}
...
#pragma HLS stream variable = fifo_A2_from_off_chip_to_S1 depth = 1024
  hls::stream<float16> fifo_B2_from_off_chip_to_S1;
#pragma HLS stream variable = fifo_B2_from_off_chip_to_S1 depth = 1024
  hls::stream<float16> fifo_B1_from_off_chip_to_S1;
...
#pragma HLS stream variable = fifo_C_from_off_chip_to_S0 depth = 1024
  ...
  FT0_level0(alpha, beta, fifo_C_from_off_chip_to_S0,
             fifo_B1_from_off_chip_to_S1, fifo_B2_from_off_chip_to_S1,
             fifo_A2_from_off_chip_to_S1, fifo_A1_from_off_chip_to_S1,
             fifo_C_to_off_chip);
