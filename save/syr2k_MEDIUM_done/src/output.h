...
void load_vC_for_task0(
    hls::stream<ap_axiu<128, 0, 0, 0>> &fifo_C_from_off_chip_to_S0,
    float4 vC[14400]);
...
void load_vB2_for_task1(hls::stream<float16> &fifo_B2_from_off_chip_to_S1,
                        float16 vB2[3120]);
void load_vB2_for_task1(
    hls::stream<ap_axiu<512, 0, 0, 0>> &fifo_B2_from_off_chip_to_S1,
    float16 vB2[3120]);
...
void store_vC_for_task0(hls::stream<float4> &fifo_C_to_off_chip,
                        float4 vC[14400]);
void store_vC_for_task0(hls::stream<ap_axiu<128, 0, 0, 0>> &fifo_C_to_off_chip,
                        float4 vC[14400]);
...
void compute_FT0_level1(float alpha, float beta,
                        ...
                        hls::stream<float16> &fifo_A1_from_off_chip_to_S1,
                        hls::stream<float4> &fifo_C_to_off_chip,
                        float B1[30][208], float A2[30][208], int i0, int j0,
                        float C_0[30][12], float C_1[30][12], float C_2[30][12],
...
void FT0_level1(float alpha, float beta,
                ...
                hls::stream<float16> &fifo_A2_from_off_chip_to_S1,
                hls::stream<float16> &fifo_A1_from_off_chip_to_S1,
                hls::stream<float4> &fifo_C_to_off_chip, float B1[30][208],
                float A2[30][208], float A1_0[240][208], float A1_1[240][208],
                float A1_2[240][208], float B2_0[240][208],
                float B2_1[240][208], float B2_2[240][208], int i0);
void task0_intra(float alpha, float beta, float B1[30][208], float A2[30][208],
                 float A1[240][208], float B2[240][208], int i0,
                 float C[30][12], int j0);
void task1_intra(float alpha, float beta, float B1[30][208], float A2[30][208],
                 float A1[240][208], float B2[240][208], int i0,
                 float C[30][12], int j0);
void read_B1_FT0(float B1[30][208],
                 hls::stream<float16> &fifo_B1_from_off_chip_to_S1, int i0);
void read_B1_FT0(
    float B1[30][208],
    hls::stream<ap_axiu<512, 0, 0, 0>> &fifo_B1_from_off_chip_to_S1, int i0);
void read_A2_FT0(float A2[30][208],
                 hls::stream<float16> &fifo_A2_from_off_chip_to_S1, int i0);
void read_A2_FT0(
    float A2[30][208],
    hls::stream<ap_axiu<512, 0, 0, 0>> &fifo_A2_from_off_chip_to_S1, int i0);
void read_C_FT0(float C[30][12],
...
void read_A1_FT0(
    float A1[240][208],
    hls::stream<ap_axiu<512, 0, 0, 0>> &fifo_A1_from_off_chip_to_S1, int j0,
    int i0);
...
void read_B2_FT0(
    float B2[240][208],
    hls::stream<ap_axiu<512, 0, 0, 0>> &fifo_B2_from_off_chip_to_S1, int j0,
    int i0);
void write_C_FT0(float C[30][12], hls::stream<float4> &fifo_C_to_off_chip,
                 int j0, int i0);
void write_C_FT0(float C[30][12],
                 hls::stream<ap_axiu<128, 0, 0, 0>> &fifo_C_to_off_chip, int j0,
                 int i0);
void kernel_nlp_slr0(float alpha, float beta, float4 vC_for_task0[14400],
