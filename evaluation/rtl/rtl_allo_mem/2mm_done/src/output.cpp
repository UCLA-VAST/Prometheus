...
void kernel_nlp(
  ...
  #pragma HLS INTERFACE s_axilite port = v40 bundle = control
  #pragma HLS INTERFACE s_axilite port = v41 bundle = control
  #pragma HLS INTERFACE s_axilite port = v42 bundle = control
  #pragma HLS INTERFACE s_axilite port = v43 bundle = control
  #pragma HLS INTERFACE s_axilite port = v44 bundle = control
