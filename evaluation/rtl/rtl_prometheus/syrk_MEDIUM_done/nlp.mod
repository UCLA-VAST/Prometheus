...
#comment: Statement 1: C[i][j] += alpha * A1[i][k] * A2[j][k];
#comment: Loop_0: i
#comment: Loop_1: j
#comment: Loop_2: i
#comment: Loop_3: k
...
#comment: Argument 4: float A2[240][200]
...
#comment: Array A2 has for tc in dim 0 TC4 (ori=TC4_ori) arg0
...
#comment: Sched 1 has reuse buffer A1[TC2_1][TC3_1]
#comment: Sched 1 has reuse buffer A2[TC4_1][TC3_1]
...
subject to con12: is_fused_task0_in_SLR_0 * (footprint_C_S0_S1_reuse + footprint_A1_S1_reuse + footprint_A2_S1_reuse) <= SLR0_mem; # memory constraint per SLR
...
subject to con23: level_reuse_A1_FT0_under1 = level_transfer_A1_FT0_under1; # reuse level have to be outermost or equal to transfer
subject to con24: level_reuse_A1_FT0_under2 = level_transfer_A1_FT0_under2; # reuse level have to be outermost or equal to transfer
...
subject to con27: level_reuse_A2_FT0_under0 >= level_transfer_A2_FT0_under0; # reuse level have to be outermost or equal to transfer
subject to con28: level_reuse_A2_FT0_under0 + level_reuse_A2_FT0_under1 >= level_transfer_A2_FT0_under1; # reuse level have to be outermost or equal to transfer
subject to con29: level_reuse_A2_FT0_under0 + level_reuse_A2_FT0_under1 + level_reuse_A2_FT0_under2 >= level_transfer_A2_FT0_under2; # reuse level have to be outermost or equal to transfer
subject to con30: level_transfer_A2_FT0_under0 + level_transfer_A2_FT0_under1 + level_transfer_A2_FT0_under2 = 1; # only one level of transfer for A2
subject to con31: level_reuse_A2_FT0_under0 + level_reuse_A2_FT0_under1 + level_reuse_A2_FT0_under2 = 1; # only one level of reuse for A2
...
subject to con33: Lat_comp_fused_S0_S1_2 = (perm0_S0 * TC1_0 + perm1_S0 * TC0_0) * max(Lat_comp_fused_S0_S1_3, level_transfer_C_FT0_under2 * footprint_C_S0_S1 / burst_C, level_transfer_A1_FT0_under2 * footprint_A1_S1 / burst_A1, level_transfer_A2_FT0_under2 * footprint_A2_S1 / burst_A2) + Lat_comp_fused_S0_S1_3 + max(level_transfer_C_FT0_under2 * footprint_C_S0_S1 / burst_C, level_transfer_A1_FT0_under2 * footprint_A1_S1 / burst_A1, level_transfer_A2_FT0_under2 * footprint_A2_S1 / burst_A2  + level_transfer_C_FT0_under2 * footprint_C_S0_S1 / burst_C); # latency of the fused task S0_S1 level 2
subject to con34: Lat_comp_fused_S0_S1_1 = (perm0_S0 * TC0_0 + perm1_S0 * TC1_0) * max(Lat_comp_fused_S0_S1_2, level_transfer_C_FT0_under1 * footprint_C_S0_S1 / burst_C, level_transfer_A1_FT0_under1 * footprint_A1_S1 / burst_A1, level_transfer_A2_FT0_under1 * footprint_A2_S1 / burst_A2) + Lat_comp_fused_S0_S1_2 + max(level_transfer_C_FT0_under1 * footprint_C_S0_S1 / burst_C, level_transfer_A1_FT0_under1 * footprint_A1_S1 / burst_A1, level_transfer_A2_FT0_under1 * footprint_A2_S1 / burst_A2  + level_transfer_C_FT0_under1 * footprint_C_S0_S1 / burst_C); # latency of the fused task S0_S1 level 1
subject to con35: Lat_comp_fused_S0_S1 = Lat_comp_fused_S0_S1_1 + level_transfer_C_FT0_under0 * footprint_tot_C_FT0 / burst_C + level_transfer_A1_FT0_under0 * footprint_tot_A1_FT0 / burst_A1 + level_transfer_A2_FT0_under0 * footprint_tot_A2_FT0 / burst_A2; # latency of the fused task S0_S1
...
subject to con38: perm4_S1 * level_transfer_A1_FT0_under1 = 0; # useless to transfer under this loop
subject to con39: perm4_S1 * level_reuse_A1_FT0_under1 = 0; # useless to reuse under this loop
subject to con40: perm5_S1 * level_transfer_A1_FT0_under1 = 0; # useless to transfer under this loop
subject to con41: perm5_S1 * level_reuse_A1_FT0_under1 = 0; # useless to reuse under this loop
subject to con42: perm1_S1 * level_transfer_A1_FT0_under2 = 0; # useless to transfer under this loop
subject to con43: perm1_S1 * level_reuse_A1_FT0_under2 = 0; # useless to reuse under this loop
subject to con44: perm3_S1 * level_transfer_A1_FT0_under2 = 0; # useless to transfer under this loop
subject to con45: perm3_S1 * level_reuse_A1_FT0_under2 = 0; # useless to reuse under this loop
subject to con46: footprint_A1_S1 = level_transfer_A1_FT0_under0 * footprint_tot_A1_FT0 + level_transfer_A1_FT0_under1 * (perm0_S1 * footprint_tot_A1_FT0/ TC2_0 + perm1_S1 * footprint_tot_A1_FT0/ TC2_0 + perm2_S1 * footprint_tot_A1_FT0/ TC3_0 + perm3_S1 * footprint_tot_A1_FT0/ TC3_0 + perm4_S1 * footprint_tot_A1_FT0 + perm5_S1 * footprint_tot_A1_FT0) + level_transfer_A1_FT0_under2 * (perm0_S1 * footprint_tot_A1_FT0/ TC2_0/ TC3_0 + perm1_S1 * footprint_tot_A1_FT0/ TC2_0 + perm2_S1 * footprint_tot_A1_FT0/ TC3_0/ TC2_0 + perm3_S1 * footprint_tot_A1_FT0/ TC3_0 + perm4_S1 * footprint_tot_A1_FT0/ TC2_0 + perm5_S1 * footprint_tot_A1_FT0/ TC3_0); # footprint of the array A1 for the fused task 0
subject to con47: footprint_A1_S1_reuse = level_reuse_A1_FT0_under0 * footprint_tot_A1_FT0 + level_reuse_A1_FT0_under1 * (perm0_S1 * footprint_tot_A1_FT0/ TC2_0 + perm1_S1 * footprint_tot_A1_FT0/ TC2_0 + perm2_S1 * footprint_tot_A1_FT0/ TC3_0 + perm3_S1 * footprint_tot_A1_FT0/ TC3_0 + perm4_S1 * footprint_tot_A1_FT0 + perm5_S1 * footprint_tot_A1_FT0) + level_reuse_A1_FT0_under2 * (perm0_S1 * footprint_tot_A1_FT0/ TC2_0/ TC3_0 + perm1_S1 * footprint_tot_A1_FT0/ TC2_0 + perm2_S1 * footprint_tot_A1_FT0/ TC3_0/ TC2_0 + perm3_S1 * footprint_tot_A1_FT0/ TC3_0 + perm4_S1 * footprint_tot_A1_FT0/ TC2_0 + perm5_S1 * footprint_tot_A1_FT0/ TC3_0); # footprint of the array A1 for the fused task 0
subject to con48: perm0_S1 * level_transfer_A2_FT0_under1 = 0; # useless to transfer under this loop
subject to con49: perm0_S1 * level_reuse_A2_FT0_under1 = 0; # useless to reuse under this loop
subject to con50: perm1_S1 * level_transfer_A2_FT0_under1 = 0; # useless to transfer under this loop
subject to con51: perm1_S1 * level_reuse_A2_FT0_under1 = 0; # useless to reuse under this loop
subject to con52: perm2_S1 * level_transfer_A2_FT0_under2 = 0; # useless to transfer under this loop
subject to con53: perm2_S1 * level_reuse_A2_FT0_under2 = 0; # useless to reuse under this loop
subject to con54: perm4_S1 * level_transfer_A2_FT0_under2 = 0; # useless to transfer under this loop
subject to con55: perm4_S1 * level_reuse_A2_FT0_under2 = 0; # useless to reuse under this loop
subject to con56: footprint_A2_S1 = level_transfer_A2_FT0_under0 * footprint_tot_A2_FT0 + level_transfer_A2_FT0_under1 * (perm0_S1 * footprint_tot_A2_FT0 + perm1_S1 * footprint_tot_A2_FT0 + perm2_S1 * footprint_tot_A2_FT0/ TC3_0 + perm3_S1 * footprint_tot_A2_FT0/ TC3_0 + perm4_S1 * footprint_tot_A2_FT0/ TC4_0 + perm5_S1 * footprint_tot_A2_FT0/ TC4_0) + level_transfer_A2_FT0_under2 * (perm0_S1 * footprint_tot_A2_FT0/ TC3_0 + perm1_S1 * footprint_tot_A2_FT0/ TC4_0 + perm2_S1 * footprint_tot_A2_FT0/ TC3_0 + perm3_S1 * footprint_tot_A2_FT0/ TC3_0/ TC4_0 + perm4_S1 * footprint_tot_A2_FT0/ TC4_0 + perm5_S1 * footprint_tot_A2_FT0/ TC4_0/ TC3_0); # footprint of the array A2 for the fused task 0
subject to con57: footprint_A2_S1_reuse = level_reuse_A2_FT0_under0 * footprint_tot_A2_FT0 + level_reuse_A2_FT0_under1 * (perm0_S1 * footprint_tot_A2_FT0 + perm1_S1 * footprint_tot_A2_FT0 + perm2_S1 * footprint_tot_A2_FT0/ TC3_0 + perm3_S1 * footprint_tot_A2_FT0/ TC3_0 + perm4_S1 * footprint_tot_A2_FT0/ TC4_0 + perm5_S1 * footprint_tot_A2_FT0/ TC4_0) + level_reuse_A2_FT0_under2 * (perm0_S1 * footprint_tot_A2_FT0/ TC3_0 + perm1_S1 * footprint_tot_A2_FT0/ TC4_0 + perm2_S1 * footprint_tot_A2_FT0/ TC3_0 + perm3_S1 * footprint_tot_A2_FT0/ TC3_0/ TC4_0 + perm4_S1 * footprint_tot_A2_FT0/ TC4_0 + perm5_S1 * footprint_tot_A2_FT0/ TC4_0/ TC3_0); # footprint of the array A2 for the fused task 0
...
subject to con67: TC2_1 * TC3_1 <= CONSTRAINT_ARRAY_PARTITIONING_VALUE; # array part for array A1 
subject to con68: TC4_1 * TC3_1 <= CONSTRAINT_ARRAY_PARTITIONING_VALUE; # array part for array A2 
...
subject to con87: A2_is_fully_transfered_on_last_dim_FT0 = level_transfer_A2_FT0_under0 + perm0_S1 * (level_transfer_A2_FT0_under1) + perm1_S1 * (level_transfer_A2_FT0_under1 + level_transfer_A2_FT0_under2) + perm4_S1 * (level_transfer_A2_FT0_under1 + level_transfer_A2_FT0_under2) + perm5_S1 * (level_transfer_A2_FT0_under1); # the array A2 is fully transfered on the last dimension
subject to con88: burst_A2_is_1 * cte_0 * 1 = burst_A2_is_1 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con89: is_tc3_burst_witout_tiling_for_A2 =  min(1, cte_burst_without_tiling_TC3_for_A2);
subject to con90: burst_A2_is_2 * cte_1 * 2 = burst_A2_is_2 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con91: burst_A2_is_4 * cte_2 * 4 = burst_A2_is_4 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con92: burst_A2_is_8 * cte_3 * 8 = burst_A2_is_8 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con93: burst_A2_is_16 * cte_4 * 16 = burst_A2_is_16 * ((1-is_tc3_burst_witout_tiling_for_A2) * (TC3_1 * (1-A2_is_fully_transfered_on_last_dim_FT0) + TC3 * (A2_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC3_for_A2 + TC3));
subject to con94: burst_A2 = burst_A2_is_1 * 1 + burst_A2_is_2 * 2 + burst_A2_is_4 * 4 + burst_A2_is_8 * 8 + burst_A2_is_16 * 16; # burst size of the array A2
subject to con95: burst_A2_is_1 + burst_A2_is_2 + burst_A2_is_4 + burst_A2_is_8 + burst_A2_is_16 = 1; # only one burst size for the array A2
subject to con96: is_tc3_burst_witout_tiling_for_A2 <= A2_is_fully_transfered_on_last_dim_FT0;
...
subject to con125: A1_is_fully_transfered_on_last_dim_FT0 = level_transfer_A1_FT0_under0 + perm0_S1 * (level_transfer_A1_FT0_under1) + perm1_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm4_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm5_S1 * (level_transfer_A1_FT0_under1); # the array A1 is fully transfered on the last dimension
subject to con126: burst_A1_is_1 * cte_25 * 1 = burst_A1_is_1 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con127: is_tc3_burst_witout_tiling_for_A1 =  min(1, cte_burst_without_tiling_TC3_for_A1);
subject to con128: burst_A1_is_2 * cte_26 * 2 = burst_A1_is_2 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con129: burst_A1_is_4 * cte_27 * 4 = burst_A1_is_4 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con130: burst_A1_is_8 * cte_28 * 8 = burst_A1_is_8 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con131: burst_A1_is_16 * cte_29 * 16 = burst_A1_is_16 * ((1-is_tc3_burst_witout_tiling_for_A1) * (TC3_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC3 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC3_for_A1 + TC3));
subject to con132: burst_A1 = burst_A1_is_1 * 1 + burst_A1_is_2 * 2 + burst_A1_is_4 * 4 + burst_A1_is_8 * 8 + burst_A1_is_16 * 16; # burst size of the array A1
subject to con133: burst_A1_is_1 + burst_A1_is_2 + burst_A1_is_4 + burst_A1_is_8 + burst_A1_is_16 = 1; # only one burst size for the array A1
subject to con134: is_tc3_burst_witout_tiling_for_A1 <= A1_is_fully_transfered_on_last_dim_FT0;
subject to con135: footprint_tot_A2_FT0 = TC4_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_A2);
...
subject to con138: footprint_tot_A1_FT0 = TC2_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_A1);
subject to con139: TC0 = TC0_ori;
subject to con140: TC2 = TC2_ori;
subject to con141: obj = Lat_comp_fused_S0_S1 + 1/burst_A2 + 1/burst_C + 1/burst_A1 + 1/(is_slr0_used);
...
subject to con144: buffer_size = footprint_C_S0_S1_reuse + footprint_A1_S1_reuse + footprint_A2_S1_reuse; # total buffer size
subject to con145: fifo_size = 0; # total fifo size
subject to con146: buffer_size + fifo_size <= ON_CHIP_MEM_SIZE; # on-chip mem size
subject to con147: perm0_S1 * level_reuse_A2_FT0_under0 = perm0_S1 * 1;
subject to con148: perm1_S1 * level_reuse_A2_FT0_under0 = perm1_S1 * 1;
...
subject to con151: perm4_S1 * level_reuse_A1_FT0_under0 = perm4_S1 * 1;
subject to con152: perm5_S1 * level_reuse_A1_FT0_under0 = perm5_S1 * 1;
solve;
display TC0;
display TC1;
display TC2;
