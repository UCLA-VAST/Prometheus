...
void load_vC_for_task0(
    hls::stream<ap_axiu<256, 0, 0, 0>> &fifo_C_from_off_chip_to_S0,
    float8 vC[7200]);
void store_vC_for_task0(hls::stream<float8> &fifo_C_to_off_chip,
                        float8 vC[7200]);
void store_vC_for_task0(hls::stream<ap_axiu<256, 0, 0, 0>> &fifo_C_to_off_chip,
                        float8 vC[7200]);
...
void write_C_FT0(float C[60][8], hls::stream<float8> &fifo_C_to_off_chip,
                 int j0, int i0);
void write_C_FT0(float C[60][8],
                 hls::stream<ap_axiu<256, 0, 0, 0>> &fifo_C_to_off_chip, int j0,
                 int i0);
void kernel_nlp_slr0(float alpha, float beta, float8 vC_for_task0[7200],
