...
int main(int argc, char* argv[]) {
    ...
    kernel.setArg(argN++, v5);
    kernel.setArg(argN++, v6);
    kernel.setArg(argN++, v7NewOCL);
    kernel.setArg(argN++, v8NewOCL);
    
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects(
                       {v0NewOCL, v1NewOCL, v2NewOCL, v3NewOCL,v4NewOCL}, 0, nullptr, nullptr));
    q.finish();
    cl::Event kernelCompute;
    OCL_CHECK(err, err = q.enqueueTask(kernel, nullptr, &kernelCompute));
    q.finish();
    kernelCompute.wait();
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({v7NewOCL, v8NewOCL},
