...
int main() {
  ...
  float A_new_before_trans_0[180 * 200] = {0};
  float A_new_0[180 * 200] = {0};
  float B_ori[200][190] = {0};
  float B_new_before_trans_0[200 * 192] = {0};
  float B_new_0[200 * 192] = {0};
  float F_ori[190][210] = {0};
  float F_new_before_trans_0[192 * 210] = {0};
  float F_new_0[192 * 210] = {0};
  float C_ori[190][220] = {0};
  float C_new_before_trans_0[190 * 224] = {0};
  float C_new_0[190 * 224] = {0};
  float D_ori[220][210] = {0};
  float D_new_before_trans_0[224 * 210] = {0};
  float D_new_0[224 * 210] = {0};
  float G_ori[180][210] = {0};
  float G_new_before_trans_0[180 * 210] = {0};
  float G_new_0[180 * 210] = {0};
  int memIndex = 0;
  float val;
  ...
  for (int i0 = 0; i0 < 180; i0++) {
    for (int i1 = 0; i1 < 200; i1++) {
      val = ((float)rand() / RAND_MAX);
      A_ori[i0][i1] = val;
      A_new_before_trans_0[i0 * 200 + i1 * 1] = val;
      A_new_0[i0 * 200 + i1 * 1] = val;
    }
  }
  // if padding we need to change data order
  memIndex = 0;
  ...
  for (int d0_0 = 0; d0_0 < 20; d0_0++) {
    for (int d0_1 = 0; d0_1 < 9; d0_1++) {
      for (int d1 = 0; d1 < 200; d1++) {
        int d0 = d0_0 * 9 + d0_1;
        A_new_0[memIndex] = A_new_before_trans_0[d0 * 200 + d1 * 1];
        memIndex++;
      }
    }
  }
  ...
  for (int i0 = 0; i0 < 190; i0++) {
    for (int i1 = 0; i1 < 210; i1++) {
      val = ((float)rand() / RAND_MAX);
      F_ori[i0][i1] = val;
      F_new_before_trans_0[i0 * 210 + i1 * 1] = val;
      F_new_0[i0 * 210 + i1 * 1] = val;
    }
  }
  // if padding we need to change data order
  memIndex = 0;
  //['d1_0', 'd0_0', 'd0_1', 'd1_1']
  for (int d1_0 = 0; d1_0 < 21; d1_0++) {
    for (int d0_0 = 0; d0_0 < 19; d0_0++) {
      for (int d0_1 = 0; d0_1 < 10; d0_1++) {
        for (int d1_1 = 0; d1_1 < 10; d1_1++) {
          int d0 = d0_0 * 10 + d0_1;
          int d1 = d1_0 * 10 + d1_1;
          F_new_0[memIndex] = F_new_before_trans_0[d0 * 210 + d1 * 1];
          memIndex++;
        }
      }
    }
  ...
  for (int i0 = 0; i0 < 220; i0++) {
    for (int i1 = 0; i1 < 210; i1++) {
      val = ((float)rand() / RAND_MAX);
      D_ori[i0][i1] = val;
      D_new_before_trans_0[i0 * 210 + i1 * 1] = val;
      D_new_0[i0 * 210 + i1 * 1] = val;
    }
  }
  // if padding we need to change data order
  memIndex = 0;
    ...
    for (int d0_0 = 0; d0_0 < 56; d0_0++) {
      for (int d0_1 = 0; d0_1 < 4; d0_1++) {
        for (int d1_1 = 0; d1_1 < 10; d1_1++) {
          int d0 = d0_0 * 4 + d0_1;
          int d1 = d1_0 * 10 + d1_1;
          D_new_0[memIndex] = D_new_before_trans_0[d0 * 210 + d1 * 1];
          memIndex++;
        }
      }
    }
  ...
  for (int i0 = 0; i0 < 180; i0++) {
    for (int i1 = 0; i1 < 210; i1++) {
      val = ((float)rand() / RAND_MAX);
      G_ori[i0][i1] = val;
      G_new_before_trans_0[i0 * 210 + i1 * 1] = val;
      G_new_0[i0 * 210 + i1 * 1] = val;
    }
  }
  // if padding we need to change data order
  memIndex = 0;
    ...
    for (int d0_0 = 0; d0_0 < 20; d0_0++) {
      for (int d0_1 = 0; d0_1 < 9; d0_1++) {
        for (int d1_1 = 0; d1_1 < 10; d1_1++) {
          int d0 = d0_0 * 9 + d0_1;
          int d1 = d1_0 * 10 + d1_1;
          G_new_0[memIndex] = G_new_before_trans_0[d0 * 210 + d1 * 1];
          memIndex++;
        }
      }
    }
  ...
  kernel_nlp((float16 *)E_new_0, (float8 *)A_new_0, (float16 *)B_new_0,
             (float2 *)F_new_0, (float16 *)C_new_0, (float2 *)D_new_0,
             (float2 *)G_new_0);
  memIndex = 0;
  for (int d0_0 = 0; d0_0 < 20; d0_0++) {
    for (int d1_0 = 0; d1_0 < 12; d1_0++) {
    ...
    for (int d0_0 = 0; d0_0 < 19; d0_0++) {
      for (int d0_1 = 0; d0_1 < 10; d0_1++) {
        for (int d1_1 = 0; d1_1 < 10; d1_1++) {
          int d0 = d0_0 * 10 + d0_1;
          int d1 = d1_0 * 10 + d1_1;
          F_new_before_trans_0[d0 * 210 + d1 * 1] = F_new_0[memIndex];
          memIndex++;
        }
      }
    }
  ...
  for (int i0 = 0; i0 < 190; i0++) {
    for (int i1 = 0; i1 < 210; i1++) {
      if (abs(F_ori[i0][i1] - F_new_before_trans_0[i0 * 210 + i1 * 1]) >
          0.0001) {
        printf("Error in F... %d  %d %f %f\n", i0, i1, F_ori[i0][i1],
               F_new_before_trans_0[i0 * 210 + i1 * 1]);
        return 1;
      }
    }
  }
    ...
    for (int d0_0 = 0; d0_0 < 20; d0_0++) {
      for (int d0_1 = 0; d0_1 < 9; d0_1++) {
        for (int d1_1 = 0; d1_1 < 10; d1_1++) {
          int d0 = d0_0 * 9 + d0_1;
          int d1 = d1_0 * 10 + d1_1;
          G_new_before_trans_0[d0 * 210 + d1 * 1] = G_new_0[memIndex];
          memIndex++;
        }
      }
    }
  ...
  for (int i0 = 0; i0 < 180; i0++) {
    for (int i1 = 0; i1 < 210; i1++) {
      if (abs(G_ori[i0][i1] - G_new_before_trans_0[i0 * 210 + i1 * 1]) >
          0.0001) {
        printf("Error in G... %d  %d %f %f\n", i0, i1, G_ori[i0][i1],
               G_new_before_trans_0[i0 * 210 + i1 * 1]);
        return 1;
      }
    }
  }
