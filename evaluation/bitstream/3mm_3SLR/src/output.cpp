...
void compute_FT0_level1(hls::stream<float16> &fifo_E_from_task1_to_task5,
                        ...
                        hls::stream<float16> &fifo_A_from_off_chip_to_S1,
                        hls::stream<float16> &fifo_E_to_off_chip,
                        float A[10][200], float B[200][192], int i0, int j0,
                        float E_0[10][48], float E_1[10][48]) {
#pragma HLS inline off
#pragma HLS dataflow
...
void FT0_level1(hls::stream<float16> &fifo_E_from_task1_to_task5,
                hls::stream<float16> &fifo_B_from_off_chip_to_S1,
                hls::stream<float16> &fifo_A_from_off_chip_to_S1,
                hls::stream<float16> &fifo_E_to_off_chip, float A[10][200],
...
void compute_FT1_level1(hls::stream<float8> &fifo_F_from_task3_to_task5,
                        hls::stream<float16> &fifo_C_from_off_chip_to_S3,
                        hls::stream<float8> &fifo_D_from_off_chip_to_S3,
                        hls::stream<float8> &fifo_F_to_off_chip,
                        float D[224][24], int j0, int i0, float F_0[10][24],
                        float F_1[10][24], float C_0[190][224],
                        float C_1[190][224]) {
#pragma HLS inline off
#pragma HLS dataflow
...
void compute_FT2_level1(hls::stream<float16> &fifo_E_from_task1_to_task5,
                        hls::stream<float8> &fifo_F_from_task3_to_task5,
                        hls::stream<float8> &fifo_G_to_off_chip,
                        float F[192][24], int j0, int i0, float G_0[10][24],
                        float G_1[10][24], float E_0[180][192],
                        float E_1[180][192]) {
#pragma HLS inline off
#pragma HLS dataflow
...
void FT2_level1(hls::stream<float16> &fifo_E_from_task1_to_task5,
                hls::stream<float8> &fifo_F_from_task3_to_task5,
                hls::stream<float8> &fifo_G_to_off_chip, float F[192][24],
