...
var cte_burst_TC2_for_x integer >= 1;
var cte_burst_TC0_for_tmp integer >= 1;
var cte_burst_TC1_for_tmp integer >= 1;
var cte_burst_TC4_for_tmp integer >= 1;
var cte_burst_TC3_for_y integer >= 1;
var cte_burst_TC5_for_y integer >= 1;
var cte_burst_TC2_for_A integer >= 1;
var cte_burst_TC5_for_A integer >= 1;
var Lat_comp_0_1 >= 0;
var obj >= 0;
...
subject to con111: TC0_1 = TC1_1; # same intra tile for the same dimension of the array tmp in the fused task
subject to con112: TC3_1 = TC5_1; # same intra tile for the same dimension of the array y in the fused task
subject to con113: x_is_fully_transfered_on_last_dim_FT0 = level_transfer_x_FT0_under0 + perm0_S1 * (level_transfer_x_FT0_under1); # the array x is fully transfered on the last dimension
subject to con114: burst_x_is_1 * cte_0 * 1 = burst_x_is_1 * ((1-is_tc2_burst_witout_tiling_for_x) * (TC2_1 * (1-x_is_fully_transfered_on_last_dim_FT0) + TC2 * (x_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_x * (cte_burst_without_tiling_TC2_for_x + TC2));
subject to con115: is_tc2_burst_witout_tiling_for_x =  min(1, cte_burst_without_tiling_TC2_for_x);
subject to con116: burst_x_is_2 * cte_1 * 2 = burst_x_is_2 * ((1-is_tc2_burst_witout_tiling_for_x) * (TC2_1 * (1-x_is_fully_transfered_on_last_dim_FT0) + TC2 * (x_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_x * (cte_burst_without_tiling_TC2_for_x + TC2));
subject to con117: burst_x_is_4 * cte_2 * 4 = burst_x_is_4 * ((1-is_tc2_burst_witout_tiling_for_x) * (TC2_1 * (1-x_is_fully_transfered_on_last_dim_FT0) + TC2 * (x_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_x * (cte_burst_without_tiling_TC2_for_x + TC2));
subject to con118: burst_x_is_8 * cte_3 * 8 = burst_x_is_8 * ((1-is_tc2_burst_witout_tiling_for_x) * (TC2_1 * (1-x_is_fully_transfered_on_last_dim_FT0) + TC2 * (x_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_x * (cte_burst_without_tiling_TC2_for_x + TC2));
subject to con119: burst_x_is_16 * cte_4 * 16 = burst_x_is_16 * ((1-is_tc2_burst_witout_tiling_for_x) * (TC2_1 * (1-x_is_fully_transfered_on_last_dim_FT0) + TC2 * (x_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_x * (cte_burst_without_tiling_TC2_for_x + TC2));
subject to con120: burst_x = burst_x_is_1 * 1 + burst_x_is_2 * 2 + burst_x_is_4 * 4 + burst_x_is_8 * 8 + burst_x_is_16 * 16; # burst size of the array x
subject to con121: burst_x_is_1 + burst_x_is_2 + burst_x_is_4 + burst_x_is_8 + burst_x_is_16 = 1; # only one burst size for the array x
subject to con122: is_tc2_burst_witout_tiling_for_x <= x_is_fully_transfered_on_last_dim_FT0;
subject to con123: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0; # the array tmp is fully transfered on the last dimension
subject to con124: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0 + perm1_S1 * (level_transfer_tmp_FT0_under1); # the array tmp is fully transfered on the last dimension
subject to con125: tmp_is_fully_transfered_on_last_dim_FT1 = level_transfer_tmp_FT1_under0 + perm1_S3 * (level_transfer_tmp_FT1_under1); # the array tmp is fully transfered on the last dimension
subject to con126: burst_tmp_is_1 * cte_5 * 1 = burst_tmp_is_1 * ((1-is_tc0_burst_witout_tiling_for_tmp) * (TC0_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC0 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC0_for_tmp + TC0));
subject to con127: is_tc0_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC0_for_tmp);
subject to con128: burst_tmp_is_1 * cte_6 * 1 = burst_tmp_is_1 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con129: is_tc1_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC1_for_tmp);
subject to con130: burst_tmp_is_1 * cte_7 * 1 = burst_tmp_is_1 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con131: burst_tmp_is_1 * cte_8 * 1 = burst_tmp_is_1 * ((1-is_tc4_burst_witout_tiling_for_tmp) * (TC4_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC4 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC4_for_tmp + TC4));
subject to con132: is_tc4_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC4_for_tmp);
subject to con133: burst_tmp_is_2 * cte_9 * 2 = burst_tmp_is_2 * ((1-is_tc0_burst_witout_tiling_for_tmp) * (TC0_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC0 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC0_for_tmp + TC0));
subject to con134: burst_tmp_is_2 * cte_10 * 2 = burst_tmp_is_2 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con135: burst_tmp_is_2 * cte_11 * 2 = burst_tmp_is_2 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con136: burst_tmp_is_2 * cte_12 * 2 = burst_tmp_is_2 * ((1-is_tc4_burst_witout_tiling_for_tmp) * (TC4_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC4 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC4_for_tmp + TC4));
subject to con137: burst_tmp_is_4 * cte_13 * 4 = burst_tmp_is_4 * ((1-is_tc0_burst_witout_tiling_for_tmp) * (TC0_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC0 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC0_for_tmp + TC0));
subject to con138: burst_tmp_is_4 * cte_14 * 4 = burst_tmp_is_4 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con139: burst_tmp_is_4 * cte_15 * 4 = burst_tmp_is_4 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con140: burst_tmp_is_4 * cte_16 * 4 = burst_tmp_is_4 * ((1-is_tc4_burst_witout_tiling_for_tmp) * (TC4_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC4 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC4_for_tmp + TC4));
subject to con141: burst_tmp_is_8 * cte_17 * 8 = burst_tmp_is_8 * ((1-is_tc0_burst_witout_tiling_for_tmp) * (TC0_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC0 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC0_for_tmp + TC0));
subject to con142: burst_tmp_is_8 * cte_18 * 8 = burst_tmp_is_8 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con143: burst_tmp_is_8 * cte_19 * 8 = burst_tmp_is_8 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con144: burst_tmp_is_8 * cte_20 * 8 = burst_tmp_is_8 * ((1-is_tc4_burst_witout_tiling_for_tmp) * (TC4_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC4 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC4_for_tmp + TC4));
subject to con145: burst_tmp_is_16 * cte_21 * 16 = burst_tmp_is_16 * ((1-is_tc0_burst_witout_tiling_for_tmp) * (TC0_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC0 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc0_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC0_for_tmp + TC0));
subject to con146: burst_tmp_is_16 * cte_22 * 16 = burst_tmp_is_16 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con147: burst_tmp_is_16 * cte_23 * 16 = burst_tmp_is_16 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con148: burst_tmp_is_16 * cte_24 * 16 = burst_tmp_is_16 * ((1-is_tc4_burst_witout_tiling_for_tmp) * (TC4_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC4 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc4_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC4_for_tmp + TC4));
subject to con149: burst_tmp = burst_tmp_is_1 * 1 + burst_tmp_is_2 * 2 + burst_tmp_is_4 * 4 + burst_tmp_is_8 * 8 + burst_tmp_is_16 * 16; # burst size of the array tmp
subject to con150: burst_tmp_is_1 + burst_tmp_is_2 + burst_tmp_is_4 + burst_tmp_is_8 + burst_tmp_is_16 = 1; # only one burst size for the array tmp
subject to con151: is_tc0_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con152: is_tc1_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con153: is_tc4_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT1;
subject to con154: y_is_fully_transfered_on_last_dim_FT1 = level_transfer_y_FT1_under0; # the array y is fully transfered on the last dimension
subject to con155: y_is_fully_transfered_on_last_dim_FT1 = level_transfer_y_FT1_under0 + perm0_S3 * (level_transfer_y_FT1_under1); # the array y is fully transfered on the last dimension
subject to con156: burst_y_is_1 * cte_25 * 1 = burst_y_is_1 * ((1-is_tc3_burst_witout_tiling_for_y) * (TC3_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC3 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC3_for_y + TC3));
subject to con157: is_tc3_burst_witout_tiling_for_y =  min(1, cte_burst_without_tiling_TC3_for_y);
subject to con158: burst_y_is_1 * cte_26 * 1 = burst_y_is_1 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con159: is_tc5_burst_witout_tiling_for_y =  min(1, cte_burst_without_tiling_TC5_for_y);
subject to con160: burst_y_is_1 * cte_27 * 1 = burst_y_is_1 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con161: burst_y_is_2 * cte_28 * 2 = burst_y_is_2 * ((1-is_tc3_burst_witout_tiling_for_y) * (TC3_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC3 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC3_for_y + TC3));
subject to con162: burst_y_is_2 * cte_29 * 2 = burst_y_is_2 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con163: burst_y_is_2 * cte_30 * 2 = burst_y_is_2 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con164: burst_y_is_4 * cte_31 * 4 = burst_y_is_4 * ((1-is_tc3_burst_witout_tiling_for_y) * (TC3_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC3 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC3_for_y + TC3));
subject to con165: burst_y_is_4 * cte_32 * 4 = burst_y_is_4 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con166: burst_y_is_4 * cte_33 * 4 = burst_y_is_4 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con167: burst_y_is_8 * cte_34 * 8 = burst_y_is_8 * ((1-is_tc3_burst_witout_tiling_for_y) * (TC3_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC3 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC3_for_y + TC3));
subject to con168: burst_y_is_8 * cte_35 * 8 = burst_y_is_8 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con169: burst_y_is_8 * cte_36 * 8 = burst_y_is_8 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con170: burst_y_is_16 * cte_37 * 16 = burst_y_is_16 * ((1-is_tc3_burst_witout_tiling_for_y) * (TC3_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC3 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc3_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC3_for_y + TC3));
subject to con171: burst_y_is_16 * cte_38 * 16 = burst_y_is_16 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con172: burst_y_is_16 * cte_39 * 16 = burst_y_is_16 * ((1-is_tc5_burst_witout_tiling_for_y) * (TC5_1 * (1-y_is_fully_transfered_on_last_dim_FT1) + TC5 * (y_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_y * (cte_burst_without_tiling_TC5_for_y + TC5));
subject to con173: burst_y = burst_y_is_1 * 1 + burst_y_is_2 * 2 + burst_y_is_4 * 4 + burst_y_is_8 * 8 + burst_y_is_16 * 16; # burst size of the array y
subject to con174: burst_y_is_1 + burst_y_is_2 + burst_y_is_4 + burst_y_is_8 + burst_y_is_16 = 1; # only one burst size for the array y
subject to con175: is_tc3_burst_witout_tiling_for_y <= y_is_fully_transfered_on_last_dim_FT1;
subject to con176: is_tc5_burst_witout_tiling_for_y <= y_is_fully_transfered_on_last_dim_FT1;
subject to con177: A_is_fully_transfered_on_last_dim_FT0 = level_transfer_A_FT0_under0 + perm0_S1 * (level_transfer_A_FT0_under1); # the array A is fully transfered on the last dimension
subject to con178: A_is_fully_transfered_on_last_dim_FT1 = level_transfer_A_FT1_under0 + perm0_S3 * (level_transfer_A_FT1_under1); # the array A is fully transfered on the last dimension
subject to con179: burst_A_is_1 * cte_40 * 1 = burst_A_is_1 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con180: is_tc2_burst_witout_tiling_for_A =  min(1, cte_burst_without_tiling_TC2_for_A);
subject to con181: burst_A_is_1 * cte_41 * 1 = burst_A_is_1 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con182: is_tc5_burst_witout_tiling_for_A =  min(1, cte_burst_without_tiling_TC5_for_A);
subject to con183: burst_A_is_2 * cte_42 * 2 = burst_A_is_2 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con184: burst_A_is_2 * cte_43 * 2 = burst_A_is_2 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con185: burst_A_is_4 * cte_44 * 4 = burst_A_is_4 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con186: burst_A_is_4 * cte_45 * 4 = burst_A_is_4 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con187: burst_A_is_8 * cte_46 * 8 = burst_A_is_8 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con188: burst_A_is_8 * cte_47 * 8 = burst_A_is_8 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con189: burst_A_is_16 * cte_48 * 16 = burst_A_is_16 * ((1-is_tc2_burst_witout_tiling_for_A) * (TC2_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC2 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc2_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC2_for_A + TC2));
subject to con190: burst_A_is_16 * cte_49 * 16 = burst_A_is_16 * ((1-is_tc5_burst_witout_tiling_for_A) * (TC5_1 * (1-A_is_fully_transfered_on_last_dim_FT1) + TC5 * (A_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC5_for_A + TC5));
subject to con191: burst_A = burst_A_is_1 * 1 + burst_A_is_2 * 2 + burst_A_is_4 * 4 + burst_A_is_8 * 8 + burst_A_is_16 * 16; # burst size of the array A
subject to con192: burst_A_is_1 + burst_A_is_2 + burst_A_is_4 + burst_A_is_8 + burst_A_is_16 = 1; # only one burst size for the array A
subject to con193: is_tc2_burst_witout_tiling_for_A <= A_is_fully_transfered_on_last_dim_FT0;
subject to con194: is_tc5_burst_witout_tiling_for_A <= A_is_fully_transfered_on_last_dim_FT1;
subject to con195: TC2_1 = burst_x * cte_burst_TC2_for_x;
subject to con196: footprint_tot_x_FT0 = TC2_0 * (TC2_1 + cte_burst_without_tiling_TC2_for_x);
subject to con197: TC0_1 = burst_tmp * cte_burst_TC0_for_tmp;
subject to con198: footprint_tot_tmp_FT0 = TC0_0 * (TC0_1 + cte_burst_without_tiling_TC0_for_tmp);
subject to con199: TC1_1 = burst_tmp * cte_burst_TC1_for_tmp;
subject to con200: footprint_tot_tmp_FT0 = TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_tmp);
subject to con201: TC4_1 = burst_tmp * cte_burst_TC4_for_tmp;
subject to con202: footprint_tot_tmp_FT1 = TC4_0 * (TC4_1 + cte_burst_without_tiling_TC4_for_tmp);
subject to con203: TC3_1 = burst_y * cte_burst_TC3_for_y;
subject to con204: footprint_tot_y_FT1 = TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_y);
subject to con205: TC5_1 = burst_y * cte_burst_TC5_for_y;
subject to con206: footprint_tot_y_FT1 = TC5_0 * (TC5_1 + cte_burst_without_tiling_TC5_for_y);
subject to con207: TC2_1 = burst_A * cte_burst_TC2_for_A;
subject to con208: footprint_tot_A_FT0 = TC1_ori * TC2_0 * (TC2_1 + cte_burst_without_tiling_TC2_for_A);
subject to con209: TC5_1 = burst_A * cte_burst_TC5_for_A;
subject to con210: footprint_tot_A_FT1 = TC4_ori * TC5_0 * (TC5_1 + cte_burst_without_tiling_TC5_for_A);
subject to con211: obj = max(shift_0_to_1 + Lat_comp_fused_S2_S3, Lat_comp_fused_S0_S1) + 1/burst_x + 1/burst_tmp + 1/burst_y + 1/burst_A + 1/(is_slr0_used + is_slr1_used + is_slr2_used);
subject to con212: tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT0 * max(TC0_1, TC1_1) = tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT0 * min(TC0_1, TC1_1) * cte_tiling_0; # should divide for tmp in dim 0
subject to con213: tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT1 * max(TC0_1, TC4_1) = tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT1 * min(TC0_1, TC4_1) * cte_tiling_1; # should divide for tmp in dim 0
subject to con214: tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT1 * max(TC1_1, TC4_1) = tmp_is_fully_transfered_on_last_dim_FT0 * tmp_is_fully_transfered_on_last_dim_FT1 * min(TC1_1, TC4_1) * cte_tiling_2; # should divide for tmp in dim 0
subject to con215: A_is_fully_transfered_on_last_dim_FT0 * A_is_fully_transfered_on_last_dim_FT1 * max(TC1_1, TC4_1) = A_is_fully_transfered_on_last_dim_FT0 * A_is_fully_transfered_on_last_dim_FT1 * min(TC1_1, TC4_1) * cte_tiling_3; # should divide for A in dim 0
subject to con216: A_is_fully_transfered_on_last_dim_FT0 * A_is_fully_transfered_on_last_dim_FT1 * max(TC2_1, TC5_1) = A_is_fully_transfered_on_last_dim_FT0 * A_is_fully_transfered_on_last_dim_FT1 * min(TC2_1, TC5_1) * cte_tiling_4; # should divide for A in dim 1
subject to con217: y_is_fully_transfered_on_last_dim_FT1 * y_is_fully_transfered_on_last_dim_FT1 * max(TC3_1, TC5_1) = y_is_fully_transfered_on_last_dim_FT1 * y_is_fully_transfered_on_last_dim_FT1 * min(TC3_1, TC5_1) * cte_tiling_5; # should divide for y in dim 0
subject to con218: buffer_size = footprint_tmp_S0_S1_reuse + footprint_A_S1_reuse + footprint_x_S1_reuse + footprint_tmp_S3_reuse + footprint_A_S3_reuse + footprint_y_S2_S3_reuse; # total buffer size
subject to con219: fifo_size = 0; # total fifo size
subject to con220: buffer_size + fifo_size <= ON_CHIP_MEM_SIZE; # on-chip mem size
subject to con221: perm0_S1 * level_reuse_x_FT0_under0 = perm0_S1 * 1;
subject to con222: perm1_S1 * level_reuse_tmp_FT0_under0 = perm1_S1 * 1;
subject to con223: perm1_S3 * level_reuse_tmp_FT1_under0 = perm1_S3 * 1;
subject to con224: perm0_S3 * level_reuse_y_FT1_under0 = perm0_S3 * 1;
solve;
display TC0;
display TC1;
display TC2;
...
display cte_burst_TC2_for_x;
display cte_burst_TC0_for_tmp;
display cte_burst_TC1_for_tmp;
display cte_burst_TC4_for_tmp;
display cte_burst_TC3_for_y;
display cte_burst_TC5_for_y;
display cte_burst_TC2_for_A;
display cte_burst_TC5_for_A;
