...
void FT1_level0(hls::stream<float16>& fifo_A_from_off_chip_to_S3, hls::stream<float16>& fifo_p_from_off_chip_to_S3, hls::stream<float2>& fifo_q_to_off_chip);
...
void read_A_FT0(float A[416][16], hls::stream<float16>& fifo_A_from_off_chip_to_S1, int j0);
