...
subject to con171: TC5_1 = TC7_1; # same intra tile for the same dimension of the array D in the fused task
subject to con172: TC6_1 = TC8_1; # same intra tile for the same dimension of the array D in the fused task
subject to con173: TC0_1 = TC2_1; # same intra tile for the same dimension of the array tmp in the fused task
subject to con174: TC1_1 = TC3_1; # same intra tile for the same dimension of the array tmp in the fused task
subject to con175: C_is_fully_transfered_on_last_dim_FT1 = level_transfer_C_FT1_under0 + perm0_S3 * (level_transfer_C_FT1_under1) + perm1_S3 * (level_transfer_C_FT1_under1 + level_transfer_C_FT1_under2) + perm4_S3 * (level_transfer_C_FT1_under1 + level_transfer_C_FT1_under2) + perm5_S3 * (level_transfer_C_FT1_under1); # the array C is fully transfered on the last dimension
subject to con176: burst_C_is_1 * cte_0 * 1 = burst_C_is_1 * ((1-is_tc8_burst_witout_tiling_for_C) * (TC8_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC8 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC8_for_C + TC8));
subject to con177: is_tc8_burst_witout_tiling_for_C =  min(1, cte_burst_without_tiling_TC8_for_C);
subject to con178: burst_C_is_2 * cte_1 * 2 = burst_C_is_2 * ((1-is_tc8_burst_witout_tiling_for_C) * (TC8_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC8 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC8_for_C + TC8));
subject to con179: burst_C_is_4 * cte_2 * 4 = burst_C_is_4 * ((1-is_tc8_burst_witout_tiling_for_C) * (TC8_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC8 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC8_for_C + TC8));
subject to con180: burst_C_is_8 * cte_3 * 8 = burst_C_is_8 * ((1-is_tc8_burst_witout_tiling_for_C) * (TC8_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC8 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC8_for_C + TC8));
subject to con181: burst_C_is_16 * cte_4 * 16 = burst_C_is_16 * ((1-is_tc8_burst_witout_tiling_for_C) * (TC8_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC8 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC8_for_C + TC8));
subject to con182: burst_C = burst_C_is_1 * 1 + burst_C_is_2 * 2 + burst_C_is_4 * 4 + burst_C_is_8 * 8 + burst_C_is_16 * 16; # burst size of the array C
subject to con183: burst_C_is_1 + burst_C_is_2 + burst_C_is_4 + burst_C_is_8 + burst_C_is_16 = 1; # only one burst size for the array C
subject to con184: is_tc8_burst_witout_tiling_for_C <= C_is_fully_transfered_on_last_dim_FT1;
subject to con185: D_is_fully_transfered_on_last_dim_FT1 = level_transfer_D_FT1_under0 + perm0_S2 * (level_transfer_D_FT1_under1); # the array D is fully transfered on the last dimension
subject to con186: D_is_fully_transfered_on_last_dim_FT1 = level_transfer_D_FT1_under0 + perm0_S3 * (level_transfer_D_FT1_under1) + perm1_S3 * (level_transfer_D_FT1_under1 + level_transfer_D_FT1_under2) + perm4_S3 * (level_transfer_D_FT1_under1 + level_transfer_D_FT1_under2) + perm5_S3 * (level_transfer_D_FT1_under1); # the array D is fully transfered on the last dimension
subject to con187: burst_D_is_1 * cte_5 * 1 = burst_D_is_1 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con188: is_tc6_burst_witout_tiling_for_D =  min(1, cte_burst_without_tiling_TC6_for_D);
subject to con189: burst_D_is_1 * cte_6 * 1 = burst_D_is_1 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con190: burst_D_is_1 * cte_7 * 1 = burst_D_is_1 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con191: is_tc8_burst_witout_tiling_for_D =  min(1, cte_burst_without_tiling_TC8_for_D);
subject to con192: burst_D_is_1 * cte_8 * 1 = burst_D_is_1 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con193: burst_D_is_2 * cte_9 * 2 = burst_D_is_2 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con194: burst_D_is_2 * cte_10 * 2 = burst_D_is_2 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con195: burst_D_is_2 * cte_11 * 2 = burst_D_is_2 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con196: burst_D_is_2 * cte_12 * 2 = burst_D_is_2 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con197: burst_D_is_4 * cte_13 * 4 = burst_D_is_4 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con198: burst_D_is_4 * cte_14 * 4 = burst_D_is_4 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con199: burst_D_is_4 * cte_15 * 4 = burst_D_is_4 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con200: burst_D_is_4 * cte_16 * 4 = burst_D_is_4 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con201: burst_D_is_8 * cte_17 * 8 = burst_D_is_8 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con202: burst_D_is_8 * cte_18 * 8 = burst_D_is_8 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con203: burst_D_is_8 * cte_19 * 8 = burst_D_is_8 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con204: burst_D_is_8 * cte_20 * 8 = burst_D_is_8 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con205: burst_D_is_16 * cte_21 * 16 = burst_D_is_16 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con206: burst_D_is_16 * cte_22 * 16 = burst_D_is_16 * ((1-is_tc6_burst_witout_tiling_for_D) * (TC6_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC6 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC6_for_D + TC6));
subject to con207: burst_D_is_16 * cte_23 * 16 = burst_D_is_16 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con208: burst_D_is_16 * cte_24 * 16 = burst_D_is_16 * ((1-is_tc8_burst_witout_tiling_for_D) * (TC8_1 * (1-D_is_fully_transfered_on_last_dim_FT1) + TC8 * (D_is_fully_transfered_on_last_dim_FT1)) + is_tc8_burst_witout_tiling_for_D * (cte_burst_without_tiling_TC8_for_D + TC8));
subject to con209: burst_D = burst_D_is_1 * 1 + burst_D_is_2 * 2 + burst_D_is_4 * 4 + burst_D_is_8 * 8 + burst_D_is_16 * 16; # burst size of the array D
subject to con210: burst_D_is_1 + burst_D_is_2 + burst_D_is_4 + burst_D_is_8 + burst_D_is_16 = 1; # only one burst size for the array D
subject to con211: is_tc6_burst_witout_tiling_for_D <= D_is_fully_transfered_on_last_dim_FT1;
subject to con212: is_tc8_burst_witout_tiling_for_D <= D_is_fully_transfered_on_last_dim_FT1;
subject to con213: A_is_fully_transfered_on_last_dim_FT0 = level_transfer_A_FT0_under0 + perm0_S1 * (level_transfer_A_FT0_under1 + level_transfer_A_FT0_under2) + perm1_S1 * (level_transfer_A_FT0_under1) + perm2_S1 * (level_transfer_A_FT0_under1 + level_transfer_A_FT0_under2) + perm3_S1 * (level_transfer_A_FT0_under1); # the array A is fully transfered on the last dimension
subject to con214: burst_A_is_1 * cte_25 * 1 = burst_A_is_1 * ((1-is_tc4_burst_witout_tiling_for_A) * (TC4_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC4 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC4_for_A + TC4));
subject to con215: is_tc4_burst_witout_tiling_for_A =  min(1, cte_burst_without_tiling_TC4_for_A);
subject to con216: burst_A_is_2 * cte_26 * 2 = burst_A_is_2 * ((1-is_tc4_burst_witout_tiling_for_A) * (TC4_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC4 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC4_for_A + TC4));
subject to con217: burst_A_is_4 * cte_27 * 4 = burst_A_is_4 * ((1-is_tc4_burst_witout_tiling_for_A) * (TC4_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC4 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC4_for_A + TC4));
subject to con218: burst_A_is_8 * cte_28 * 8 = burst_A_is_8 * ((1-is_tc4_burst_witout_tiling_for_A) * (TC4_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC4 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC4_for_A + TC4));
subject to con219: burst_A_is_16 * cte_29 * 16 = burst_A_is_16 * ((1-is_tc4_burst_witout_tiling_for_A) * (TC4_1 * (1-A_is_fully_transfered_on_last_dim_FT0) + TC4 * (A_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A * (cte_burst_without_tiling_TC4_for_A + TC4));
subject to con220: burst_A = burst_A_is_1 * 1 + burst_A_is_2 * 2 + burst_A_is_4 * 4 + burst_A_is_8 * 8 + burst_A_is_16 * 16; # burst size of the array A
subject to con221: burst_A_is_1 + burst_A_is_2 + burst_A_is_4 + burst_A_is_8 + burst_A_is_16 = 1; # only one burst size for the array A
subject to con222: is_tc4_burst_witout_tiling_for_A <= A_is_fully_transfered_on_last_dim_FT0;
subject to con223: B_is_fully_transfered_on_last_dim_FT0 = level_transfer_B_FT0_under0 + perm0_S1 * (level_transfer_B_FT0_under1) + perm1_S1 * (level_transfer_B_FT0_under1 + level_transfer_B_FT0_under2) + perm4_S1 * (level_transfer_B_FT0_under1 + level_transfer_B_FT0_under2) + perm5_S1 * (level_transfer_B_FT0_under1); # the array B is fully transfered on the last dimension
subject to con224: burst_B_is_1 * cte_30 * 1 = burst_B_is_1 * ((1-is_tc3_burst_witout_tiling_for_B) * (TC3_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC3 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC3_for_B + TC3));
subject to con225: is_tc3_burst_witout_tiling_for_B =  min(1, cte_burst_without_tiling_TC3_for_B);
subject to con226: burst_B_is_2 * cte_31 * 2 = burst_B_is_2 * ((1-is_tc3_burst_witout_tiling_for_B) * (TC3_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC3 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC3_for_B + TC3));
subject to con227: burst_B_is_4 * cte_32 * 4 = burst_B_is_4 * ((1-is_tc3_burst_witout_tiling_for_B) * (TC3_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC3 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC3_for_B + TC3));
subject to con228: burst_B_is_8 * cte_33 * 8 = burst_B_is_8 * ((1-is_tc3_burst_witout_tiling_for_B) * (TC3_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC3 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC3_for_B + TC3));
subject to con229: burst_B_is_16 * cte_34 * 16 = burst_B_is_16 * ((1-is_tc3_burst_witout_tiling_for_B) * (TC3_1 * (1-B_is_fully_transfered_on_last_dim_FT0) + TC3 * (B_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B * (cte_burst_without_tiling_TC3_for_B + TC3));
subject to con230: burst_B = burst_B_is_1 * 1 + burst_B_is_2 * 2 + burst_B_is_4 * 4 + burst_B_is_8 * 8 + burst_B_is_16 * 16; # burst size of the array B
subject to con231: burst_B_is_1 + burst_B_is_2 + burst_B_is_4 + burst_B_is_8 + burst_B_is_16 = 1; # only one burst size for the array B
subject to con232: is_tc3_burst_witout_tiling_for_B <= B_is_fully_transfered_on_last_dim_FT0;
subject to con233: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0 + perm0_S0 * (level_transfer_tmp_FT0_under1); # the array tmp is fully transfered on the last dimension
subject to con234: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0 + perm0_S1 * (level_transfer_tmp_FT0_under1) + perm1_S1 * (level_transfer_tmp_FT0_under1 + level_transfer_tmp_FT0_under2) + perm4_S1 * (level_transfer_tmp_FT0_under1 + level_transfer_tmp_FT0_under2) + perm5_S1 * (level_transfer_tmp_FT0_under1); # the array tmp is fully transfered on the last dimension
subject to con235: tmp_is_fully_transfered_on_last_dim_FT1 = level_transfer_tmp_FT1_under0 + perm0_S3 * (level_transfer_tmp_FT1_under1 + level_transfer_tmp_FT1_under2) + perm1_S3 * (level_transfer_tmp_FT1_under1) + perm2_S3 * (level_transfer_tmp_FT1_under1 + level_transfer_tmp_FT1_under2) + perm3_S3 * (level_transfer_tmp_FT1_under1); # the array tmp is fully transfered on the last dimension
subject to con236: burst_tmp_is_1 * cte_35 * 1 = burst_tmp_is_1 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con237: is_tc1_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC1_for_tmp);
subject to con238: burst_tmp_is_1 * cte_36 * 1 = burst_tmp_is_1 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con239: is_tc3_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC3_for_tmp);
subject to con240: burst_tmp_is_1 * cte_37 * 1 = burst_tmp_is_1 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con241: burst_tmp_is_1 * cte_38 * 1 = burst_tmp_is_1 * ((1-is_tc9_burst_witout_tiling_for_tmp) * (TC9_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC9 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC9_for_tmp + TC9));
subject to con242: is_tc9_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC9_for_tmp);
subject to con243: burst_tmp_is_2 * cte_39 * 2 = burst_tmp_is_2 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con244: burst_tmp_is_2 * cte_40 * 2 = burst_tmp_is_2 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con245: burst_tmp_is_2 * cte_41 * 2 = burst_tmp_is_2 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con246: burst_tmp_is_2 * cte_42 * 2 = burst_tmp_is_2 * ((1-is_tc9_burst_witout_tiling_for_tmp) * (TC9_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC9 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC9_for_tmp + TC9));
subject to con247: burst_tmp_is_4 * cte_43 * 4 = burst_tmp_is_4 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con248: burst_tmp_is_4 * cte_44 * 4 = burst_tmp_is_4 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con249: burst_tmp_is_4 * cte_45 * 4 = burst_tmp_is_4 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con250: burst_tmp_is_4 * cte_46 * 4 = burst_tmp_is_4 * ((1-is_tc9_burst_witout_tiling_for_tmp) * (TC9_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC9 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC9_for_tmp + TC9));
subject to con251: burst_tmp_is_8 * cte_47 * 8 = burst_tmp_is_8 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con252: burst_tmp_is_8 * cte_48 * 8 = burst_tmp_is_8 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con253: burst_tmp_is_8 * cte_49 * 8 = burst_tmp_is_8 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con254: burst_tmp_is_8 * cte_50 * 8 = burst_tmp_is_8 * ((1-is_tc9_burst_witout_tiling_for_tmp) * (TC9_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC9 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC9_for_tmp + TC9));
subject to con255: burst_tmp_is_16 * cte_51 * 16 = burst_tmp_is_16 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con256: burst_tmp_is_16 * cte_52 * 16 = burst_tmp_is_16 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con257: burst_tmp_is_16 * cte_53 * 16 = burst_tmp_is_16 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con258: burst_tmp_is_16 * cte_54 * 16 = burst_tmp_is_16 * ((1-is_tc9_burst_witout_tiling_for_tmp) * (TC9_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC9 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC9_for_tmp + TC9));
subject to con259: burst_tmp = burst_tmp_is_1 * 1 + burst_tmp_is_2 * 2 + burst_tmp_is_4 * 4 + burst_tmp_is_8 * 8 + burst_tmp_is_16 * 16; # burst size of the array tmp
subject to con260: burst_tmp_is_1 + burst_tmp_is_2 + burst_tmp_is_4 + burst_tmp_is_8 + burst_tmp_is_16 = 1; # only one burst size for the array tmp
subject to con261: is_tc1_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con262: is_tc3_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con263: is_tc9_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT1;
subject to con264: footprint_tot_C_FT1 = TC9_ori * TC8_0 * (TC8_1 + cte_burst_without_tiling_TC8_for_C);
subject to con265: footprint_tot_D_FT1 = TC5_ori * TC6_0 * (TC6_1 + cte_burst_without_tiling_TC6_for_D);
subject to con266: footprint_tot_D_FT1 = TC7_ori * TC8_0 * (TC8_1 + cte_burst_without_tiling_TC8_for_D);
subject to con267: footprint_tot_A_FT0 = TC2_ori * TC4_0 * (TC4_1 + cte_burst_without_tiling_TC4_for_A);
subject to con268: footprint_tot_B_FT0 = TC4_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_B);
subject to con269: footprint_tot_tmp_FT0 = TC0_ori * TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_tmp);
subject to con270: footprint_tot_tmp_FT0 = TC2_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_tmp);
subject to con271: footprint_tot_tmp_FT1 = TC7_ori * TC9_0 * (TC9_1 + cte_burst_without_tiling_TC9_for_tmp);
subject to con272: TC0 = TC0_ori;
subject to con273: TC2 = TC2_ori;
subject to con274: TC5 = TC5_ori;
subject to con275: TC7 = TC7_ori;
subject to con276: obj = max(shift_0_to_1 + Lat_comp_fused_S2_S3, Lat_comp_fused_S0_S1) + 1/burst_C + 1/burst_D + 1/burst_A + 1/burst_B + 1/burst_tmp + 1/(is_slr0_used);
...
subject to con312: perm0_S3 * level_reuse_C_FT1_under0 = perm0_S3 * 1;
subject to con313: perm1_S3 * level_reuse_C_FT1_under0 = perm1_S3 * 1;
subject to con314: perm4_S3 * level_reuse_D_FT1_under0 = perm4_S3 * 1;
subject to con315: perm5_S3 * level_reuse_D_FT1_under0 = perm5_S3 * 1;
subject to con316: perm2_S1 * level_reuse_A_FT0_under0 = perm2_S1 * 1;
subject to con317: perm3_S1 * level_reuse_A_FT0_under0 = perm3_S1 * 1;
...
subject to con320: perm4_S1 * level_reuse_tmp_FT0_under0 = perm4_S1 * 1;
subject to con321: perm5_S1 * level_reuse_tmp_FT0_under0 = perm5_S1 * 1;
subject to con322: perm2_S3 * level_reuse_tmp_FT1_under0 = perm2_S3 * 1;
subject to con323: perm3_S3 * level_reuse_tmp_FT1_under0 = perm3_S3 * 1;
solve;
display TC0;
display TC1;
display TC2;
