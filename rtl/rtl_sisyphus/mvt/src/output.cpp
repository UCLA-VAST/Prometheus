...
void task0(float y_1[400], float A[400][400], float x1[400], float16 vx1[25], float16 vx2[25], float16 vy_1[25], float16 vy_2[25], float16 vA[10000]) {
    int i;
    int j;
...
void task1(float y_2[400], float A[400][400], float x2[400], float16 vx1[25], float16 vx2[25], float16 vy_1[25], float16 vy_2[25], float16 vA[10000]) {
    int i;
    int j;
    for (int i0 = 0; i0 < 1; i0++) {
...
#pragma HLS ARRAY_PARTITION variable=y_2 cyclic factor=400 dim=1
...
#pragma HLS ARRAY_PARTITION variable=x1 cyclic factor=400 dim=1
    ...
    load_y_2(y_2, vy_2);
    load_x2(x2, vx2);
    task0(y_1, A, x1, vx1, vx2, vy_1, vy_2, vA);
    task1(y_2, A, x2, vx1, vx2, vy_1, vy_2, vA);
    store_x1(x1, vx1);
    store_x2(x2, vx2);
}
