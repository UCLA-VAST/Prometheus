...
void kernel_nlp(
  ...
  #pragma HLS INTERFACE s_axilite port = v45 bundle = control
  #pragma HLS INTERFACE s_axilite port = v46 bundle = control
  #pragma HLS INTERFACE s_axilite port = v47 bundle = control
  #pragma HLS INTERFACE s_axilite port = v48 bundle = control
  #pragma HLS INTERFACE s_axilite port = v49 bundle = control
