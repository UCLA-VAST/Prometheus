...
#pragma HLS array_partition variable = s_1 cyclic factor = 16 dim = 1
  float A_0[413][16];
  // FT0
#pragma HLS array_partition variable = A_0 cyclic factor = 59 dim = 1
#pragma HLS array_partition variable = A_0 cyclic factor = 16 dim = 2
  float A_1[413][16];
  // FT0
#pragma HLS array_partition variable = A_1 cyclic factor = 59 dim = 1
#pragma HLS array_partition variable = A_1 cyclic factor = 16 dim = 2
  float r[413];
#pragma HLS array_partition variable = r cyclic factor = 59 dim = 1
