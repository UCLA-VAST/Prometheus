...
subject to con209: A2_is_fully_transfered_on_last_dim_FT1 = level_transfer_A2_FT1_under0 + perm1_S2 * (level_transfer_A2_FT1_under1); # the array A2 is fully transfered on the last dimension
subject to con210: burst_A2_is_1 * cte_0 * 1 = burst_A2_is_1 * ((1-is_tc5_burst_witout_tiling_for_A2) * (TC5_1 * (1-A2_is_fully_transfered_on_last_dim_FT1) + TC5 * (A2_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC5_for_A2 + TC5));
subject to con211: is_tc5_burst_witout_tiling_for_A2 =  min(1, cte_burst_without_tiling_TC5_for_A2);
subject to con212: burst_A2_is_2 * cte_1 * 2 = burst_A2_is_2 * ((1-is_tc5_burst_witout_tiling_for_A2) * (TC5_1 * (1-A2_is_fully_transfered_on_last_dim_FT1) + TC5 * (A2_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC5_for_A2 + TC5));
subject to con213: burst_A2_is_4 * cte_2 * 4 = burst_A2_is_4 * ((1-is_tc5_burst_witout_tiling_for_A2) * (TC5_1 * (1-A2_is_fully_transfered_on_last_dim_FT1) + TC5 * (A2_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC5_for_A2 + TC5));
subject to con214: burst_A2_is_8 * cte_3 * 8 = burst_A2_is_8 * ((1-is_tc5_burst_witout_tiling_for_A2) * (TC5_1 * (1-A2_is_fully_transfered_on_last_dim_FT1) + TC5 * (A2_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC5_for_A2 + TC5));
subject to con215: burst_A2_is_16 * cte_4 * 16 = burst_A2_is_16 * ((1-is_tc5_burst_witout_tiling_for_A2) * (TC5_1 * (1-A2_is_fully_transfered_on_last_dim_FT1) + TC5 * (A2_is_fully_transfered_on_last_dim_FT1)) + is_tc5_burst_witout_tiling_for_A2 * (cte_burst_without_tiling_TC5_for_A2 + TC5));
subject to con216: burst_A2 = burst_A2_is_1 * 1 + burst_A2_is_2 * 2 + burst_A2_is_4 * 4 + burst_A2_is_8 * 8 + burst_A2_is_16 * 16; # burst size of the array A2
subject to con217: burst_A2_is_1 + burst_A2_is_2 + burst_A2_is_4 + burst_A2_is_8 + burst_A2_is_16 = 1; # only one burst size for the array A2
subject to con218: is_tc5_burst_witout_tiling_for_A2 <= A2_is_fully_transfered_on_last_dim_FT1;
subject to con219: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0 + perm0_S0 * (level_transfer_tmp_FT0_under1); # the array tmp is fully transfered on the last dimension
subject to con220: tmp_is_fully_transfered_on_last_dim_FT0 = level_transfer_tmp_FT0_under0 + perm0_S1 * (level_transfer_tmp_FT0_under1) + perm1_S1 * (level_transfer_tmp_FT0_under1 + level_transfer_tmp_FT0_under2) + perm4_S1 * (level_transfer_tmp_FT0_under1 + level_transfer_tmp_FT0_under2) + perm5_S1 * (level_transfer_tmp_FT0_under1); # the array tmp is fully transfered on the last dimension
subject to con221: tmp_is_fully_transfered_on_last_dim_FT1 = level_transfer_tmp_FT1_under0 + perm0_S2 * (level_transfer_tmp_FT1_under1); # the array tmp is fully transfered on the last dimension
subject to con222: burst_tmp_is_1 * cte_5 * 1 = burst_tmp_is_1 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con223: is_tc1_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC1_for_tmp);
subject to con224: burst_tmp_is_1 * cte_6 * 1 = burst_tmp_is_1 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con225: is_tc3_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC3_for_tmp);
subject to con226: burst_tmp_is_1 * cte_7 * 1 = burst_tmp_is_1 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con227: burst_tmp_is_1 * cte_8 * 1 = burst_tmp_is_1 * ((1-is_tc6_burst_witout_tiling_for_tmp) * (TC6_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC6 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC6_for_tmp + TC6));
subject to con228: is_tc6_burst_witout_tiling_for_tmp =  min(1, cte_burst_without_tiling_TC6_for_tmp);
subject to con229: burst_tmp_is_2 * cte_9 * 2 = burst_tmp_is_2 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con230: burst_tmp_is_2 * cte_10 * 2 = burst_tmp_is_2 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con231: burst_tmp_is_2 * cte_11 * 2 = burst_tmp_is_2 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con232: burst_tmp_is_2 * cte_12 * 2 = burst_tmp_is_2 * ((1-is_tc6_burst_witout_tiling_for_tmp) * (TC6_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC6 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC6_for_tmp + TC6));
subject to con233: burst_tmp_is_4 * cte_13 * 4 = burst_tmp_is_4 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con234: burst_tmp_is_4 * cte_14 * 4 = burst_tmp_is_4 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con235: burst_tmp_is_4 * cte_15 * 4 = burst_tmp_is_4 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con236: burst_tmp_is_4 * cte_16 * 4 = burst_tmp_is_4 * ((1-is_tc6_burst_witout_tiling_for_tmp) * (TC6_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC6 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC6_for_tmp + TC6));
subject to con237: burst_tmp_is_8 * cte_17 * 8 = burst_tmp_is_8 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con238: burst_tmp_is_8 * cte_18 * 8 = burst_tmp_is_8 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con239: burst_tmp_is_8 * cte_19 * 8 = burst_tmp_is_8 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con240: burst_tmp_is_8 * cte_20 * 8 = burst_tmp_is_8 * ((1-is_tc6_burst_witout_tiling_for_tmp) * (TC6_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC6 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC6_for_tmp + TC6));
subject to con241: burst_tmp_is_16 * cte_21 * 16 = burst_tmp_is_16 * ((1-is_tc1_burst_witout_tiling_for_tmp) * (TC1_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC1 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc1_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC1_for_tmp + TC1));
subject to con242: burst_tmp_is_16 * cte_22 * 16 = burst_tmp_is_16 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con243: burst_tmp_is_16 * cte_23 * 16 = burst_tmp_is_16 * ((1-is_tc3_burst_witout_tiling_for_tmp) * (TC3_1 * (1-tmp_is_fully_transfered_on_last_dim_FT0) + TC3 * (tmp_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC3_for_tmp + TC3));
subject to con244: burst_tmp_is_16 * cte_24 * 16 = burst_tmp_is_16 * ((1-is_tc6_burst_witout_tiling_for_tmp) * (TC6_1 * (1-tmp_is_fully_transfered_on_last_dim_FT1) + TC6 * (tmp_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_tmp * (cte_burst_without_tiling_TC6_for_tmp + TC6));
subject to con245: burst_tmp = burst_tmp_is_1 * 1 + burst_tmp_is_2 * 2 + burst_tmp_is_4 * 4 + burst_tmp_is_8 * 8 + burst_tmp_is_16 * 16; # burst size of the array tmp
subject to con246: burst_tmp_is_1 + burst_tmp_is_2 + burst_tmp_is_4 + burst_tmp_is_8 + burst_tmp_is_16 = 1; # only one burst size for the array tmp
subject to con247: is_tc1_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con248: is_tc3_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT0;
subject to con249: is_tc6_burst_witout_tiling_for_tmp <= tmp_is_fully_transfered_on_last_dim_FT1;
subject to con250: A3_is_fully_transfered_on_last_dim_FT1 = level_transfer_A3_FT1_under0 + perm2_S3 * (level_transfer_A3_FT1_under1) + perm3_S3 * (level_transfer_A3_FT1_under1 + level_transfer_A3_FT1_under2) + perm4_S3 * (level_transfer_A3_FT1_under1) + perm5_S3 * (level_transfer_A3_FT1_under1 + level_transfer_A3_FT1_under2); # the array A3 is fully transfered on the last dimension
subject to con251: burst_A3_is_1 * cte_25 * 1 = burst_A3_is_1 * ((1-is_tc7_burst_witout_tiling_for_A3) * (TC7_1 * (1-A3_is_fully_transfered_on_last_dim_FT1) + TC7 * (A3_is_fully_transfered_on_last_dim_FT1)) + is_tc7_burst_witout_tiling_for_A3 * (cte_burst_without_tiling_TC7_for_A3 + TC7));
subject to con252: is_tc7_burst_witout_tiling_for_A3 =  min(1, cte_burst_without_tiling_TC7_for_A3);
subject to con253: burst_A3_is_2 * cte_26 * 2 = burst_A3_is_2 * ((1-is_tc7_burst_witout_tiling_for_A3) * (TC7_1 * (1-A3_is_fully_transfered_on_last_dim_FT1) + TC7 * (A3_is_fully_transfered_on_last_dim_FT1)) + is_tc7_burst_witout_tiling_for_A3 * (cte_burst_without_tiling_TC7_for_A3 + TC7));
subject to con254: burst_A3_is_4 * cte_27 * 4 = burst_A3_is_4 * ((1-is_tc7_burst_witout_tiling_for_A3) * (TC7_1 * (1-A3_is_fully_transfered_on_last_dim_FT1) + TC7 * (A3_is_fully_transfered_on_last_dim_FT1)) + is_tc7_burst_witout_tiling_for_A3 * (cte_burst_without_tiling_TC7_for_A3 + TC7));
subject to con255: burst_A3_is_8 * cte_28 * 8 = burst_A3_is_8 * ((1-is_tc7_burst_witout_tiling_for_A3) * (TC7_1 * (1-A3_is_fully_transfered_on_last_dim_FT1) + TC7 * (A3_is_fully_transfered_on_last_dim_FT1)) + is_tc7_burst_witout_tiling_for_A3 * (cte_burst_without_tiling_TC7_for_A3 + TC7));
subject to con256: burst_A3_is_16 * cte_29 * 16 = burst_A3_is_16 * ((1-is_tc7_burst_witout_tiling_for_A3) * (TC7_1 * (1-A3_is_fully_transfered_on_last_dim_FT1) + TC7 * (A3_is_fully_transfered_on_last_dim_FT1)) + is_tc7_burst_witout_tiling_for_A3 * (cte_burst_without_tiling_TC7_for_A3 + TC7));
subject to con257: burst_A3 = burst_A3_is_1 * 1 + burst_A3_is_2 * 2 + burst_A3_is_4 * 4 + burst_A3_is_8 * 8 + burst_A3_is_16 * 16; # burst size of the array A3
subject to con258: burst_A3_is_1 + burst_A3_is_2 + burst_A3_is_4 + burst_A3_is_8 + burst_A3_is_16 = 1; # only one burst size for the array A3
subject to con259: is_tc7_burst_witout_tiling_for_A3 <= A3_is_fully_transfered_on_last_dim_FT1;
subject to con260: B2_is_fully_transfered_on_last_dim_FT1 = level_transfer_B2_FT1_under0 + perm0_S2 * (level_transfer_B2_FT1_under1); # the array B2 is fully transfered on the last dimension
subject to con261: burst_B2_is_1 * cte_30 * 1 = burst_B2_is_1 * ((1-is_tc6_burst_witout_tiling_for_B2) * (TC6_1 * (1-B2_is_fully_transfered_on_last_dim_FT1) + TC6 * (B2_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_B2 * (cte_burst_without_tiling_TC6_for_B2 + TC6));
subject to con262: is_tc6_burst_witout_tiling_for_B2 =  min(1, cte_burst_without_tiling_TC6_for_B2);
subject to con263: burst_B2_is_2 * cte_31 * 2 = burst_B2_is_2 * ((1-is_tc6_burst_witout_tiling_for_B2) * (TC6_1 * (1-B2_is_fully_transfered_on_last_dim_FT1) + TC6 * (B2_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_B2 * (cte_burst_without_tiling_TC6_for_B2 + TC6));
subject to con264: burst_B2_is_4 * cte_32 * 4 = burst_B2_is_4 * ((1-is_tc6_burst_witout_tiling_for_B2) * (TC6_1 * (1-B2_is_fully_transfered_on_last_dim_FT1) + TC6 * (B2_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_B2 * (cte_burst_without_tiling_TC6_for_B2 + TC6));
subject to con265: burst_B2_is_8 * cte_33 * 8 = burst_B2_is_8 * ((1-is_tc6_burst_witout_tiling_for_B2) * (TC6_1 * (1-B2_is_fully_transfered_on_last_dim_FT1) + TC6 * (B2_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_B2 * (cte_burst_without_tiling_TC6_for_B2 + TC6));
subject to con266: burst_B2_is_16 * cte_34 * 16 = burst_B2_is_16 * ((1-is_tc6_burst_witout_tiling_for_B2) * (TC6_1 * (1-B2_is_fully_transfered_on_last_dim_FT1) + TC6 * (B2_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_B2 * (cte_burst_without_tiling_TC6_for_B2 + TC6));
subject to con267: burst_B2 = burst_B2_is_1 * 1 + burst_B2_is_2 * 2 + burst_B2_is_4 * 4 + burst_B2_is_8 * 8 + burst_B2_is_16 * 16; # burst size of the array B2
subject to con268: burst_B2_is_1 + burst_B2_is_2 + burst_B2_is_4 + burst_B2_is_8 + burst_B2_is_16 = 1; # only one burst size for the array B2
subject to con269: is_tc6_burst_witout_tiling_for_B2 <= B2_is_fully_transfered_on_last_dim_FT1;
subject to con270: B3_is_fully_transfered_on_last_dim_FT1 = level_transfer_B3_FT1_under0 + perm0_S3 * (level_transfer_B3_FT1_under1 + level_transfer_B3_FT1_under2) + perm1_S3 * (level_transfer_B3_FT1_under1) + perm2_S3 * (level_transfer_B3_FT1_under1 + level_transfer_B3_FT1_under2) + perm3_S3 * (level_transfer_B3_FT1_under1); # the array B3 is fully transfered on the last dimension
subject to con271: burst_B3_is_1 * cte_35 * 1 = burst_B3_is_1 * ((1-is_tc9_burst_witout_tiling_for_B3) * (TC9_1 * (1-B3_is_fully_transfered_on_last_dim_FT1) + TC9 * (B3_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_B3 * (cte_burst_without_tiling_TC9_for_B3 + TC9));
subject to con272: is_tc9_burst_witout_tiling_for_B3 =  min(1, cte_burst_without_tiling_TC9_for_B3);
subject to con273: burst_B3_is_2 * cte_36 * 2 = burst_B3_is_2 * ((1-is_tc9_burst_witout_tiling_for_B3) * (TC9_1 * (1-B3_is_fully_transfered_on_last_dim_FT1) + TC9 * (B3_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_B3 * (cte_burst_without_tiling_TC9_for_B3 + TC9));
subject to con274: burst_B3_is_4 * cte_37 * 4 = burst_B3_is_4 * ((1-is_tc9_burst_witout_tiling_for_B3) * (TC9_1 * (1-B3_is_fully_transfered_on_last_dim_FT1) + TC9 * (B3_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_B3 * (cte_burst_without_tiling_TC9_for_B3 + TC9));
subject to con275: burst_B3_is_8 * cte_38 * 8 = burst_B3_is_8 * ((1-is_tc9_burst_witout_tiling_for_B3) * (TC9_1 * (1-B3_is_fully_transfered_on_last_dim_FT1) + TC9 * (B3_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_B3 * (cte_burst_without_tiling_TC9_for_B3 + TC9));
subject to con276: burst_B3_is_16 * cte_39 * 16 = burst_B3_is_16 * ((1-is_tc9_burst_witout_tiling_for_B3) * (TC9_1 * (1-B3_is_fully_transfered_on_last_dim_FT1) + TC9 * (B3_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_B3 * (cte_burst_without_tiling_TC9_for_B3 + TC9));
subject to con277: burst_B3 = burst_B3_is_1 * 1 + burst_B3_is_2 * 2 + burst_B3_is_4 * 4 + burst_B3_is_8 * 8 + burst_B3_is_16 * 16; # burst size of the array B3
subject to con278: burst_B3_is_1 + burst_B3_is_2 + burst_B3_is_4 + burst_B3_is_8 + burst_B3_is_16 = 1; # only one burst size for the array B3
subject to con279: is_tc9_burst_witout_tiling_for_B3 <= B3_is_fully_transfered_on_last_dim_FT1;
subject to con280: A1_is_fully_transfered_on_last_dim_FT0 = level_transfer_A1_FT0_under0 + perm0_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm1_S1 * (level_transfer_A1_FT0_under1) + perm2_S1 * (level_transfer_A1_FT0_under1 + level_transfer_A1_FT0_under2) + perm3_S1 * (level_transfer_A1_FT0_under1); # the array A1 is fully transfered on the last dimension
subject to con281: burst_A1_is_1 * cte_40 * 1 = burst_A1_is_1 * ((1-is_tc4_burst_witout_tiling_for_A1) * (TC4_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC4 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC4_for_A1 + TC4));
subject to con282: is_tc4_burst_witout_tiling_for_A1 =  min(1, cte_burst_without_tiling_TC4_for_A1);
subject to con283: burst_A1_is_2 * cte_41 * 2 = burst_A1_is_2 * ((1-is_tc4_burst_witout_tiling_for_A1) * (TC4_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC4 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC4_for_A1 + TC4));
subject to con284: burst_A1_is_4 * cte_42 * 4 = burst_A1_is_4 * ((1-is_tc4_burst_witout_tiling_for_A1) * (TC4_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC4 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC4_for_A1 + TC4));
subject to con285: burst_A1_is_8 * cte_43 * 8 = burst_A1_is_8 * ((1-is_tc4_burst_witout_tiling_for_A1) * (TC4_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC4 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC4_for_A1 + TC4));
subject to con286: burst_A1_is_16 * cte_44 * 16 = burst_A1_is_16 * ((1-is_tc4_burst_witout_tiling_for_A1) * (TC4_1 * (1-A1_is_fully_transfered_on_last_dim_FT0) + TC4 * (A1_is_fully_transfered_on_last_dim_FT0)) + is_tc4_burst_witout_tiling_for_A1 * (cte_burst_without_tiling_TC4_for_A1 + TC4));
subject to con287: burst_A1 = burst_A1_is_1 * 1 + burst_A1_is_2 * 2 + burst_A1_is_4 * 4 + burst_A1_is_8 * 8 + burst_A1_is_16 * 16; # burst size of the array A1
subject to con288: burst_A1_is_1 + burst_A1_is_2 + burst_A1_is_4 + burst_A1_is_8 + burst_A1_is_16 = 1; # only one burst size for the array A1
subject to con289: is_tc4_burst_witout_tiling_for_A1 <= A1_is_fully_transfered_on_last_dim_FT0;
subject to con290: B1_is_fully_transfered_on_last_dim_FT0 = level_transfer_B1_FT0_under0 + perm0_S1 * (level_transfer_B1_FT0_under1) + perm1_S1 * (level_transfer_B1_FT0_under1 + level_transfer_B1_FT0_under2) + perm4_S1 * (level_transfer_B1_FT0_under1 + level_transfer_B1_FT0_under2) + perm5_S1 * (level_transfer_B1_FT0_under1); # the array B1 is fully transfered on the last dimension
subject to con291: burst_B1_is_1 * cte_45 * 1 = burst_B1_is_1 * ((1-is_tc3_burst_witout_tiling_for_B1) * (TC3_1 * (1-B1_is_fully_transfered_on_last_dim_FT0) + TC3 * (B1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B1 * (cte_burst_without_tiling_TC3_for_B1 + TC3));
subject to con292: is_tc3_burst_witout_tiling_for_B1 =  min(1, cte_burst_without_tiling_TC3_for_B1);
subject to con293: burst_B1_is_2 * cte_46 * 2 = burst_B1_is_2 * ((1-is_tc3_burst_witout_tiling_for_B1) * (TC3_1 * (1-B1_is_fully_transfered_on_last_dim_FT0) + TC3 * (B1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B1 * (cte_burst_without_tiling_TC3_for_B1 + TC3));
subject to con294: burst_B1_is_4 * cte_47 * 4 = burst_B1_is_4 * ((1-is_tc3_burst_witout_tiling_for_B1) * (TC3_1 * (1-B1_is_fully_transfered_on_last_dim_FT0) + TC3 * (B1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B1 * (cte_burst_without_tiling_TC3_for_B1 + TC3));
subject to con295: burst_B1_is_8 * cte_48 * 8 = burst_B1_is_8 * ((1-is_tc3_burst_witout_tiling_for_B1) * (TC3_1 * (1-B1_is_fully_transfered_on_last_dim_FT0) + TC3 * (B1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B1 * (cte_burst_without_tiling_TC3_for_B1 + TC3));
subject to con296: burst_B1_is_16 * cte_49 * 16 = burst_B1_is_16 * ((1-is_tc3_burst_witout_tiling_for_B1) * (TC3_1 * (1-B1_is_fully_transfered_on_last_dim_FT0) + TC3 * (B1_is_fully_transfered_on_last_dim_FT0)) + is_tc3_burst_witout_tiling_for_B1 * (cte_burst_without_tiling_TC3_for_B1 + TC3));
subject to con297: burst_B1 = burst_B1_is_1 * 1 + burst_B1_is_2 * 2 + burst_B1_is_4 * 4 + burst_B1_is_8 * 8 + burst_B1_is_16 * 16; # burst size of the array B1
subject to con298: burst_B1_is_1 + burst_B1_is_2 + burst_B1_is_4 + burst_B1_is_8 + burst_B1_is_16 = 1; # only one burst size for the array B1
subject to con299: is_tc3_burst_witout_tiling_for_B1 <= B1_is_fully_transfered_on_last_dim_FT0;
subject to con300: C_is_fully_transfered_on_last_dim_FT1 = level_transfer_C_FT1_under0 + perm0_S2 * (level_transfer_C_FT1_under1); # the array C is fully transfered on the last dimension
subject to con301: C_is_fully_transfered_on_last_dim_FT1 = level_transfer_C_FT1_under0 + perm0_S3 * (level_transfer_C_FT1_under1 + level_transfer_C_FT1_under2) + perm1_S3 * (level_transfer_C_FT1_under1) + perm2_S3 * (level_transfer_C_FT1_under1 + level_transfer_C_FT1_under2) + perm3_S3 * (level_transfer_C_FT1_under1); # the array C is fully transfered on the last dimension
subject to con302: burst_C_is_1 * cte_50 * 1 = burst_C_is_1 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con303: is_tc6_burst_witout_tiling_for_C =  min(1, cte_burst_without_tiling_TC6_for_C);
subject to con304: burst_C_is_1 * cte_51 * 1 = burst_C_is_1 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con305: burst_C_is_1 * cte_52 * 1 = burst_C_is_1 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con306: is_tc9_burst_witout_tiling_for_C =  min(1, cte_burst_without_tiling_TC9_for_C);
subject to con307: burst_C_is_1 * cte_53 * 1 = burst_C_is_1 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con308: burst_C_is_2 * cte_54 * 2 = burst_C_is_2 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con309: burst_C_is_2 * cte_55 * 2 = burst_C_is_2 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con310: burst_C_is_2 * cte_56 * 2 = burst_C_is_2 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con311: burst_C_is_2 * cte_57 * 2 = burst_C_is_2 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con312: burst_C_is_4 * cte_58 * 4 = burst_C_is_4 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con313: burst_C_is_4 * cte_59 * 4 = burst_C_is_4 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con314: burst_C_is_4 * cte_60 * 4 = burst_C_is_4 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con315: burst_C_is_4 * cte_61 * 4 = burst_C_is_4 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con316: burst_C_is_8 * cte_62 * 8 = burst_C_is_8 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con317: burst_C_is_8 * cte_63 * 8 = burst_C_is_8 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con318: burst_C_is_8 * cte_64 * 8 = burst_C_is_8 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con319: burst_C_is_8 * cte_65 * 8 = burst_C_is_8 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con320: burst_C_is_16 * cte_66 * 16 = burst_C_is_16 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con321: burst_C_is_16 * cte_67 * 16 = burst_C_is_16 * ((1-is_tc6_burst_witout_tiling_for_C) * (TC6_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC6 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc6_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC6_for_C + TC6));
subject to con322: burst_C_is_16 * cte_68 * 16 = burst_C_is_16 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con323: burst_C_is_16 * cte_69 * 16 = burst_C_is_16 * ((1-is_tc9_burst_witout_tiling_for_C) * (TC9_1 * (1-C_is_fully_transfered_on_last_dim_FT1) + TC9 * (C_is_fully_transfered_on_last_dim_FT1)) + is_tc9_burst_witout_tiling_for_C * (cte_burst_without_tiling_TC9_for_C + TC9));
subject to con324: burst_C = burst_C_is_1 * 1 + burst_C_is_2 * 2 + burst_C_is_4 * 4 + burst_C_is_8 * 8 + burst_C_is_16 * 16; # burst size of the array C
subject to con325: burst_C_is_1 + burst_C_is_2 + burst_C_is_4 + burst_C_is_8 + burst_C_is_16 = 1; # only one burst size for the array C
subject to con326: is_tc6_burst_witout_tiling_for_C <= C_is_fully_transfered_on_last_dim_FT1;
subject to con327: is_tc9_burst_witout_tiling_for_C <= C_is_fully_transfered_on_last_dim_FT1;
subject to con328: footprint_tot_A2_FT1 = TC5_0 * (TC5_1 + cte_burst_without_tiling_TC5_for_A2);
subject to con329: footprint_tot_tmp_FT0 = TC0_ori * TC1_0 * (TC1_1 + cte_burst_without_tiling_TC1_for_tmp);
subject to con330: footprint_tot_tmp_FT0 = TC2_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_tmp);
subject to con331: footprint_tot_tmp_FT1 = TC5_ori * TC6_0 * (TC6_1 + cte_burst_without_tiling_TC6_for_tmp);
subject to con332: footprint_tot_A3_FT1 = TC8_ori * TC7_0 * (TC7_1 + cte_burst_without_tiling_TC7_for_A3);
subject to con333: footprint_tot_B2_FT1 = TC5_ori * TC6_0 * (TC6_1 + cte_burst_without_tiling_TC6_for_B2);
subject to con334: footprint_tot_B3_FT1 = TC8_ori * TC9_0 * (TC9_1 + cte_burst_without_tiling_TC9_for_B3);
subject to con335: footprint_tot_A1_FT0 = TC2_ori * TC4_0 * (TC4_1 + cte_burst_without_tiling_TC4_for_A1);
subject to con336: footprint_tot_B1_FT0 = TC4_ori * TC3_0 * (TC3_1 + cte_burst_without_tiling_TC3_for_B1);
subject to con337: footprint_tot_C_FT1 = TC5_ori * TC6_0 * (TC6_1 + cte_burst_without_tiling_TC6_for_C);
subject to con338: footprint_tot_C_FT1 = TC7_ori * TC9_0 * (TC9_1 + cte_burst_without_tiling_TC9_for_C);
subject to con339: TC0 = TC0_ori;
subject to con340: TC2 = TC2_ori;
subject to con341: TC8 = TC8_ori;
subject to con342: obj = max(shift_0_to_1 + Lat_comp_fused_S2_S3, Lat_comp_fused_S0_S1) + 1/burst_A2 + 1/burst_tmp + 1/burst_A3 + 1/burst_B2 + 1/burst_B3 + 1/burst_A1 + 1/burst_B1 + 1/burst_C + 1/(is_slr0_used);
...
subject to con362: perm1_S2 * level_reuse_A2_FT1_under0 = perm1_S2 * 1;
subject to con363: perm4_S1 * level_reuse_tmp_FT0_under0 = perm4_S1 * 1;
subject to con364: perm5_S1 * level_reuse_tmp_FT0_under0 = perm5_S1 * 1;
subject to con365: perm4_S3 * level_reuse_A3_FT1_under0 = perm4_S3 * 1;
subject to con366: perm5_S3 * level_reuse_A3_FT1_under0 = perm5_S3 * 1;
subject to con367: perm0_S3 * level_reuse_B3_FT1_under0 = perm0_S3 * 1;
subject to con368: perm1_S3 * level_reuse_B3_FT1_under0 = perm1_S3 * 1;
subject to con369: perm2_S1 * level_reuse_A1_FT0_under0 = perm2_S1 * 1;
subject to con370: perm3_S1 * level_reuse_A1_FT0_under0 = perm3_S1 * 1;
subject to con371: perm0_S1 * level_reuse_B1_FT0_under0 = perm0_S1 * 1;
subject to con372: perm1_S1 * level_reuse_B1_FT0_under0 = perm1_S1 * 1;
